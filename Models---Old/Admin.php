...
/*         $result['numRows'] =  count($query);
	...
	public function updateEditedMember($data, $memberId, $adminId){
       ...
       /*  if ($managementRows > 0) {
            ...
            '" . (!empty($collegedj_sunday))? (int) $collegedj_sunday: '' ."',  
   ...
   function getMembersList()
	...
	function getGenres_album()
    {
     ...
     function updateTrack_trm($data, $trackId)
     {
         ...
         producer = '" . urlencode($producers) . "', writer = '" . urlencode($writer) . "', edited = NOW(), editedby = '" . $admin_id . "', active = '" . $availableMembers . "', review = '" . $reviewable . "', logos = '" . $logos . "', whitelabel = '" . $whiteLabel . "',  videoURL = '" . $video . "', graphicscomplete =  '" . $graphics . "', albumType =  '" . $albumType . "', link1 =  '" . $website1 . "', link2 =  '" . $website2 . "', bpm =  '" . $bpm . "', facebookLink =  '" . $facebookLink . "', twitterLink =  '" . $twitterLink . "', instagramLink =  '" . $instagramLink . "', tiktokLink =  '" . $tiktokLink . "', snapchatLink =  '" . $snapchatLink . "', othersLink =  '" . $othersLink . "', genreId =  '" . $genre . "', status = '" .$status."', memberPreviewAvailable = '" .$memberPreviewAvailable."', contact_name = '" .addslashes($contact_name)."', contact_email = '" .$contact_email."', contact_phone = '" .$contact_phone."', relationship_to_artist = '" .$relationship_to_artist."', songkey = '" .$songkey."', client = '".$client."' where id = '" . $trackId . "'");
...
/*          $chk_qry = DB::select("SELECT id FROM `tracks` WHERE artist = '" . urlencode($artist) . "' AND title = '" . urlencode($title) . "' AND deleted=0");
         ...
         $insertData = array(
             ...
             'featured_artist_2' => urlencode($featured_artist_2) ,
              'priorityType' => urlencode($priorityType) ,
               ...
               'relationship_to_artist' => urlencode($relationship_to_artist) ,
     ...
     function addTrack1_trm($data, $track_id)
     {
         ...
         if (isset($logos) && count($logos) > 1) {
          ...
          $query = DB::select("UPDATE `tracks` SET link = '" . $website . "', link1 = '" . $website1 . "', link2 = '" . $website2 . "', videoURL = '" . $video . "', facebookLink = '" . $facebook . "', twitterLink = '" . $twitter . "', instagramLink = '" . $instagram . "', tiktokLink = '" . $tiktok . "', snapchatLink = '" . $snapchat . "', othersLink = '" . $others . "', logos = '" . $logos . "' WHERE id = '" . $track_id . "'");
...
return $question_id;
  ...
  {
      $query = DB::select("select clients.id, clients.uname, clients.name, clients.editedby, clients.edited, clients.ccontact, clients.address1, clients.address2, clients.city, clients.state, clients.country, clients.email, clients.website, clients.zip, clients.phone, clients.mobile from  clients 
