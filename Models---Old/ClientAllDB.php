...
class ClientAllDB extends Model
{
   ...
   tracks left join tracks_mp3s ON tracks.id = tracks_mp3s.track where tracks.client = '$clientId' order by tracks_mp3s.preview desc limit 0, 10");
    ...
    public function updateClientInfo($data, $clientId){
        ...
        $query = DB::select("update `clients` set name = '" . urlencode($company) . "', ccontact = '" . urlencode($name) . "', address1 = '" . urlencode($address1) . "', address2 = '" . urlencode($address2) . "', city = '" . urlencode($city) . "', state = '" . urlencode($state) . "', zip = '" . $zip . "', phone = '" . $phone . "', mobile = '" . $mobile . "', email = '" . $email . "', website = '" . $website . "' where id = '" . $clientId . "'");
   ...
   order by chat_messages.messageId desc");
...

    {
        ...
        $query = DB::select("update  tracks_submitted set  artist = '" . urlencode($artist) . "', title = '" . urlencode($title) . "', producers = '" . urlencode($producer) . "', time = '" . urlencode($trackTime) . "', link =  '" . urlencode($website) . "',  album = '" . urlencode($album) . "',  releasedate = '" . $releasedate . "', moreinfo = '" . urlencode($trackInfo) . "', genreId = '" . $genre . "', subGenreId = '" . $subGenre . "', bpm = '" . $bpm . "', albumType = '" . $albumType . "', link1 = '" . $website1 . "', link2 = '" . $website2 . "', facebookLink = '" . $facebookLink . "', twitterLink = '" . $twitterLink . "' where id = '" . $trackId . "' and client = '" . $clientId . "'");
...

    {
	  ...
	  where tracks_reviews.id = '" . $commentId . "' and tracks.client = '" . $clientId . "'");
    ...
    function updateClientTrack($data, $clientId, $trackId)
    {
        ...
        $query = DB::select("update  tracks  set client = '$clientId', artist = '" . urlencode($artist) . "', title = '" . urlencode($title) . "', producer = '" . urlencode($producer) . "', time = '" . urlencode($trackTime) . "', link =  '" . urlencode($website) . "',  album = '" . urlencode($album) . "',  release_date = '" . $release_date . "', moreinfo = '" . urlencode($trackInfo) . "', genreId = '" . $genre . "', subGenreId = '" . $subGenre . "', bpm = '" . $bpm . "', facebookLink = '" . $facebookLink . "', twitterLink = '" . $twitterLink . "', instagramLink = '" . $instagramLink . "' where id = '" . $trackId . "'");
        return  $query;
    }
