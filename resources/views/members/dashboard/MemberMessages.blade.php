				...
				<div class="msg-blk f-block">
				  ...
				  <div class="hidden-lg d-none" style="">Internal chat with users</div>
				   <div class="nav nav-tabs">
						<a href="javascript:void(0)" class="ats pull-left nav-link active">ALL MESSAGES (<?php echo $messages['numRows']; ?>)</a>
						...
						<div class="msg-item unread">
							<div class="row">
								<div class="col-lg-2 col-md-1 col-sm-1 col-xs-3">
									...
									<?php 
									if(isset($senderDetails[$message->messageId]['image']) && is_numeric($senderDetails[$message->messageId]['image'])){
