            ...
            <div class="dash-heading">
              ...
              <div class="nav nav-tabs">
                               <a href="<?php echo url("Member_dashboard_newest_tracks"); ?>" class="pull-left nav-link" id="newest_tracks_tab_mem_dash">NEWEST TRACKS</a>
                                ...
                                <a href="<?php echo url("Member_dashboard_top_streaming"); ?>" id="streaming_tracks_tab_mem_dash" class="pull-left nav-link <?php if(isset($sg_topstrem)){ echo "active"; } ?> active">TOP STREAMING</a>
                           </div>
                                ...
                                <div class="item <?php echo $sgclass; ?>">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            ?>
                                            <p>
                                                <span class="mr-2"><a class="link-active" href="<?php echo $href; ?>" style="color:#fff;"><?php echo $label; ?></a></span>
                                                <span>
