                ...
                <div class="col-12">
                    ...
                    <div class="tabs-section">
                        ...
                        <div class="col-lg-12 col-md-12">
                            ...
                            <!--?php //if($memberInfo['data'][0]->dj_mixer == 0 || $memberInfo['data'][0]->radio_station == 0) { ?-->
                            <div class="<?php echo 'alert alert-block alert-warning text-center'; ?>">
                                <h5><?php echo 'Hi Member! Please take a minute to update your details before re-entering the record pool'; ?></h5>
                                <!--a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a-->
                            </div>
                            <!--?php // } ?-->
                            <form class="form-horizontal" method="post" action="" enctype="multipart/form-data" onsubmit="return validate()" autocomplete="off">
                                @csrf
                                <div class="dash-heading">
                                    <h2>MY INFO</h2>
                                    @if(request()->has('update') && request()->update == 1)
                                        <div class="success-msg">
                                            <h6 style="color:#33FF33">Profile Updated Successfully.<a href="/Member_dashboard_newest_tracks"><b> Click here</b></a> to go to record pool.</h6>
                                        </div>
                                    @endif
                                ...
                                <div class="myinfo-block">
                                    <!--<div class="row">-->
                                    <div class="row">
                                        <div class="form-group col-lg-6 col-md-6 col-sm-12">
                                            <div class="">
                                                <input class="form-control input" disabled="disabled" value="<?php echo urldecode($memberInfo['data'][0]->uname); ?>" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row align-items-center mb-4">
                                        <div class="col-auto">
                                            <div class="form-group">
                                                ...
                                                <img src="<?php echo $img; ?>" class="pimg mb-0" id="pimg">
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                            <div class="form-group ">
                                                <span>Upload Profile Picture</span>
                                                <label class="ml-2 btn-sm btn pfile mb-0">
                                                    Browse..<input style="display: none;" type="file" name="profileImage" id="profileImage" />
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-12">
                                            <div class="form-group ">
                                                <label class="req-label-dj">First Name</label>
                                                <div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group ">
                                                <label class="req-label-dj">Stage / DJ Name</label>
                                                <div>
                                                    <input name="stageName" id="stageName" class="form-control input" size="20" placeholder="Stage Name" type="text" value="<?php echo urldecode($memberInfo['data'][0]->stagename); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group ">
                                                <label class="req-label-dj">E-mail Address</label>
                                                <div>
                                                    <input name="email" id="email" class="form-control input" size="20" placeholder="Email" type="text" value="<?php echo urldecode($memberInfo['data'][0]->email); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group ">
                                                <label class="req-label-dj">Date of Birth(YYYY-MM-DD)</label>
                                                <div>
                                                    <input name="dob" id="dob" class="form-control" placeholder="YYYY-MM-DD" type="text" value="<?php echo date('Y-m-d', strtotime(urldecode($memberInfo['data'][0]->dob))); ?>" required>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group ">
                                                ...
                                                <div>
                                                    <input name="address1" id="address1" class="form-control input" size="20" placeholder="Address" type="text" value="<?php echo urldecode($memberInfo['data'][0]->address1); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group ">
                                                ...
                                                <div>
                                                    <input name="address2" class="form-control input" size="20" placeholder="Address" type="text" value="<?php echo urldecode($memberInfo['data'][0]->address2); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-12">
                                            <div class="form-group ">
                                                <label class="req-label-dj">City</label>
                                                <div>
                                                    <input name="city" id="city" class="form-control input" size="20" placeholder="City" type="text" value="<?php echo urldecode($memberInfo['data'][0]->city); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-12">
                                            <div class="form-group ">
                                                <label>State</label>
                                                <div>
                                                    <input name="state" class="form-control input" size="20" placeholder="State" type="text" value="<?php echo urldecode($memberInfo['data'][0]->state); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-12">
                                            <div class="form-group ">
                                                <label class="req-label-dj">Country</label>
                                                <div>
                                                    <input name="country" id="country" class="form-control input" size="20" placeholder="Country" type="text" value="<?php echo urldecode($memberInfo['data'][0]->country); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-12">
                                            <div class="form-group ">
                                                ...
                                                <div>
                                                    <input name="zip" class="form-control input" size="20" placeholder="Zipcode" type="text" value="<?php echo $memberInfo['data'][0]->zip; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <!--    <div class="form-group">
                            <label class="col-sm-3">age</label>
                                <div class="col-sm-9">
                                   <input name="age" class="form-control input" size="20" placeholder="Age" type="text" value="<?php echo $memberInfo['data'][0]->age; ?>">
  </div>
                            </div>-->

                                        <div class="col-sm-6 col-12">
                                            <div class="form-group ">
                                                <label class="req-label-dj">Gender</label>
                                                <div>
                                                    <input name="reg" id="reg" class="form-control input" size="20" placeholder="gender" type="text" value="<?php echo $memberInfo['data'][0]->sex; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-12">
                                            <div class="form-group ">
                                                <label class="req-label-dj">Phone No.</label>
                                                <div>
                                                    <input name="phone" id="phone" class="form-control input" size="20" placeholder="Phone" type="text" value="<?php echo $memberInfo['data'][0]->phone; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <!--                        <div class="form-group">-->
                                        ...
                                        <!--                        <div class="col-sm-9">-->
                                        <!--                           <input name="website" class="form-control input" size="20" placeholder="Website" type="text" value="<?php echo $memberInfo['data'][0]->website; ?>">-->
                                        <!--</div>-->
                                        <!--                       
                        </div>-->
                                </div>
                                <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div>
                                                    <input name="facebook" class="form-control input" size="20" placeholder="Facebook" type="text" value="<?php 
                                                    if (!empty($socialInfo['data'][0]->facebook)) {
                                                        echo $socialInfo['data'][0]->facebook;
                                                    } ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group ">
                                                <label>Twitter</label>
                                                <div>
                                                    <input name="twitter" class="form-control input" size="20" placeholder="Twitter" type="text" value="<?php if (!empty($socialInfo['data'][0]->twitter)) {                                                                                                                                     echo $socialInfo['data'][0]->twitter;                                                                                                                                                        } ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group ">
                                                ...
                                                <div>
                                                    <input name="instagram" class="form-control input" size="20" placeholder="Instagram" type="text" value="<?php if (!empty($socialInfo['data'][0]->instagram)) {                                                                                                                                      echo $socialInfo['data'][0]->instagram;                                                                                                                                                   } ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group ">
                                                ...
                                                <div>
                                                    <input name="linkedin" class="form-control input" size="20" placeholder="Linkedin" type="text" value="<?php if (!empty($socialInfo['data'][0]->linkedin)) {                                                                                                                                                      echo $socialInfo['data'][0]->linkedin;
                                                     } ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group ">
                                                ...
                                                <div>
                                                    <input name="snapchat" class="form-control input" size="20" placeholder="Snapchat" type="text" value="<?php if (!empty($socialInfo['data'][0]->snapchat)) {                                                                                                                                                      echo $socialInfo['data'][0]->snapchat;
                                                     } ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group ">
                                                <label>Tiktok</label>
                                                <div>
                                                    <input name="tiktok" class="form-control input" size="20" placeholder="Tiktok" type="text" value="<?php if (!empty($socialInfo['data'][0]->tiktok)) {                                                                                                                                                      echo $socialInfo['data'][0]->tiktok;
                                                     } ?>">
                                                </div>
                                            </div>
                                        </div>                                        
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group ">
                                                <label>Triller</label>
                                                <div>
                                                    <input name="triller" class="form-control input" size="20" placeholder="Triller" type="text" value="<?php if (!empty($socialInfo['data'][0]->triller)) {                                                                                                                                                      echo $socialInfo['data'][0]->triller;
                                                     } ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group ">
                                                <label>Twitch</label>
                                                <div>
                                                    <input name="twitch" class="form-control input" size="20" placeholder="Twitch" type="text" value="<?php if (!empty($socialInfo['data'][0]->twitch)) {                                                                                                                                                      echo $socialInfo['data'][0]->twitch;
                                                     } ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group ">
                                                ...
                                                <div>
                                                    <input name="mixcloud" class="form-control input" size="20" placeholder="Mixcloud" type="text" value="<?php if (!empty($socialInfo['data'][0]->mixcloud)) {                                                                                                                                                      echo $socialInfo['data'][0]->mixcloud;
                                                     } ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group ">
                                                <label>Reddit</label>
                                                <div>
                                                    <input name="reddit" class="form-control input" size="20" placeholder="Reddit" type="text" value="<?php if (!empty($socialInfo['data'][0]->reddit)) {                                                                                                                                                      echo $socialInfo['data'][0]->reddit;
                                                     } ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <!--                    <div class="form-group">-->
                                        <!--                    <label class="col-sm-12">MY PREFERENCES</label>-->
                                        <!--                    </div>-->
                                        <!--                    <div style="clear:both;"></div>-->
                                        <!--                    <div class="form-group">-->
                                        <!--                    <label class="col-sm-3">Audio files quality?</label>-->
                                        <!--                        <div class="col-sm-9">-->
                                        <!--                           <div class="checkbox">-->
                                        <!--                                            <label>-->
                                        <!--    <input type="radio" name="audioQuality" id="audioQuality" value="192"  class="ace" <?php if (isset($memberInfo['data'][0]->audioQuality) && strcmp($memberInfo['data'][0]->audioQuality, '192') == 0) { ?> checked="checked" <?php } ?> />-->
                                        <!--                                                <span class="lbl"> 192</span>-->
                                        <!--                                            </label>-->
                                        <!--                                        </div>-->
                                        <!--                                        <div class="checkbox">-->
                                        <!--                                            <label>-->
                                        <!--<input type="radio" name="audioQuality" id="audioQuality" value="256" class="ace" <?php if (isset($memberInfo['data'][0]->audioQuality) && strcmp($memberInfo['data'][0]->audioQuality, '256') == 0) { ?> checked="checked" <?php } ?> />-->
                                        <!--                                                <span class="lbl"> 256</span>-->
                                        <!--                                            </label>-->
                                        <!--                                        </div>-->
                                        <!--                                        <div class="checkbox">-->
                                        <!--                                          <label>-->
                                        <!--    <input type="radio" name="audioQuality" id="audioQuality" value="320" class="ace" <?php if (isset($memberInfo['data'][0]->audioQuality) && strcmp($memberInfo['data'][0]->audioQuality, '320') == 0) { ?> checked="checked" <?php } ?> />-->
                                        <!--                                                <span class="lbl">320</span>-->
                                        <!--                                            </label>-->
                                        <!--                                        </div>-->
                                        <!--                                        <div class="checkbox">-->
                                        <!--                                            <label>-->
                                        <!--<input type="radio" name="audioQuality" id="audioQuality" value="WAVE" class="ace" <?php if (isset($memberInfo['data'][0]->audioQuality) && strcmp($memberInfo['data'][0]->audioQuality, 'WAVE') == 0) { ?> checked="checked" <?php } ?> />-->
                                        ...
                                        <!--                          </div>-->
                                        <!--                        <div class="form-group">-->
                                        <!--                    <label class="col-sm-3">What type of computer do you use?</label>-->
                                        <!--                        <div class="col-sm-9">-->
                                        <!--                           <select  name="computer" size="1" id="computer" class="form-control input selectpicker">-->
                                        <!--              <option <?php if (isset($memberInfo['data'][0]->computer) && strcmp($memberInfo['data'][0]->computer, 'PC') == 0) { ?> selected="selected" <?php } ?> value="PC">PC-->
                                        <!--              </option>-->
                                        ...
                                        <!--                          </div>-->
                                        <!--                        <div class="form-group">-->
                                        <!--                    <label class="col-sm-3">Turntables Type</label>-->
                                        <!--                        <div class="col-sm-9">-->
                                        <!--                        <input name="turntablesType" class="form-control input" placeholder="Turntables Type" type="text" value="<?php echo $memberInfo['data'][0]->turntables_type; ?>">-->
                                        <!--</div>-->
                                        <!--                          </div>-->
                                        <!--                        <div class="form-group">-->
                                        <!--                    <label class="col-sm-3">Mixer Type</label>-->
                                        <!--                        <div class="col-sm-9">-->
                                        <!--                        <input name="mixerType" class="form-control input" placeholder="Mixer Type" type="text" value="<?php echo $memberInfo['data'][0]->mixer_type; ?>">-->
                                        <!--</div>-->
                                        <!--                          </div>-->
                                        <!--                        <div class="form-group">-->
                                        <!--                    <label class="col-sm-3">Needles Type</label>-->
                                        <!--                        <div class="col-sm-9">-->
                                        <!--                        <input name="needlesType" class="form-control input" placeholder="Needles Type" type="text" value="<?php echo $memberInfo['data'][0]->needles_type; ?>">-->
                                        <!--</div>-->
                                        <!--                          </div>-->
                                        <!--                    <div class="form-group">-->
                                        <!--                    <label class="col-sm-3">Headphones</label>-->
                                        <!--                        <div class="col-sm-9">-->
                                        <!--                        <input name="headphones" class="form-control input" placeholder="Headphones" type="text" value="<?php echo $memberInfo['data'][0]->headphones; ?>">-->
                                        <!--</div>-->
                                        <!--                          </div>-->
                                        <!--                        <div class="form-group">-->
                                        <!--                    <label class="col-sm-3">Preffered Player</label>-->
                                        <!--                        <div class="col-sm-9">-->
                                        <!--                           <select name="player" size="1" id="player" class="form-control input selectpicker">-->
                                        ...
                                        <!--              Media Player-->
                                        <!--              </option><option value="Real Player" <?php if (isset($memberInfo['data'][0]->player) && strcmp(urldecode($memberInfo['data'][0]->player), 'Real Player') == 0) { ?> selected="selected" <?php } ?>>Real-->
                                        <!--              Player-->
                                        <!--              </option><option value="Quicktime" <?php if (isset($memberInfo['data'][0]->player) && strcmp(urldecode($memberInfo['data'][0]->player), 'Quicktime') == 0) { ?> selected="selected" <?php } ?>>Quicktime-->
                                        <!--          </option></select>-->
                                        <!--</div>-->
                                        <!--                          </div>-->
                                        <!--                        <div class="form-group">-->
                                        <!--                    <label class="col-sm-3">Game System</label>-->
                                        <!--                        <div class="col-sm-9">-->
                                        <!--                        <input name="gameSystem" class="form-control input" placeholder="Game System" type="text" value="<?php echo $memberInfo['data'][0]->game_system; ?>">-->
                                        <!--</div>-->
                                        <!--                          </div>-->
                                        <!--                        <div class="form-group">-->
                                        <!--                    <label class="col-sm-3">Cell Phone</label>-->
                                        <!--                        <div class="col-sm-9">-->
                                        <!--                        <input name="cellPhone" class="form-control input" placeholder="Cell Phone" type="text" value="<?php echo $memberInfo['data'][0]->cell_phone; ?>">-->
                                        <!--</div>-->
                                        <!--                          </div>-->
                                        <!--                        <div class="form-group">-->
                                        <!--                    <label class="col-sm-3">Hat Size</label>-->
                                        <!--                        <div class="col-sm-9">-->
                                        <!--                        <input name="hatSize" class="form-control input" placeholder="Hat Size" type="text" value="<?php echo $memberInfo['data'][0]->hat_size; ?>">-->
                                        <!--</div>-->
                                        <!--                          </div>-->
                                        <!--                        <div class="form-group">-->
                                        <!--                    <label class="col-sm-3">Shirt Size</label>-->
                                        <!--                        <div class="col-sm-9">-->
                                        <!--                        <input name="shirtSize" class="form-control input" placeholder="Shirt Size" type="text" value="<?php echo $memberInfo['data'][0]->shirt_size; ?>">-->
                                        <!--</div>-->
                                        <!--                          </div>-->
                                        <!--                        <div class="form-group">-->
                                        <!--                    <label class="col-sm-3">Pants Size</label>-->
                                        <!--                        <div class="col-sm-9">-->
                                        <!--                        <input name="pantsSize" class="form-control input" placeholder="Pants Size" type="text" value="<?php echo $memberInfo['data'][0]->pants_size; ?>">-->
                                        <!--</div>-->
                                        <!--                          </div>-->
                                        <!--                        <div class="form-group">-->
                                        <!--                    <label class="col-sm-3">Shoe Size</label>-->
                                        <!--                        <div class="col-sm-9">-->
                                        <!--                        <input name="shoeSize" class="form-control input" placeholder="Shoe Size" type="text" value="<?php echo $memberInfo['data'][0]->shoe_size; ?>">-->
                                        <!--</div>-->
                                        <!--                          </div>-->
                                        <!--                        <div class="form-group">-->
                                        <!--                    <label class="col-sm-3">Member Points</label>-->
                                        <!--                        <div class="col-sm-9">-->
                                        <?php // echo $memberInfo['data'][0]->sex; 
                                        ?>
                                        <!--</div>-->
                                        <!--                          </div>-->
                                        <!--<div class="form-group">-->
                                        ...
                                        <!--    <div class="col-sm-9">-->
                                        <?php
                                        //   if($memberInfo['data'][0]->dj_mixer==1) { $djDisplay = 'block';  }  else { $djDisplay = 'none'; }
                                        //   if($memberInfo['data'][0]->radio_station==1) { $radioDisplay = 'block';  }  else { $radioDisplay = 'none'; }
                                        //   if($memberInfo['data'][0]->mass_media==1) { $massDisplay = 'block';  }  else { $massDisplay = 'none'; }
                                        //   if($memberInfo['data'][0]->record_label==1) { $recordDisplay = 'block';  }  else { $recordDisplay = 'none'; }
                                        //   if($memberInfo['data'][0]->management==1) { $managementDisplay = 'block';  }  else { $managementDisplay = 'none'; }
                                        //   if($memberInfo['data'][0]->clothing_apparel==1) { $clothingDisplay = 'block';  }  else { $clothingDisplay = 'none'; }
                                        //   if($memberInfo['data'][0]->promoter==1) { $promoterDisplay = 'block';  }  else { $promoterDisplay = 'none'; }
                                        //   if($memberInfo['data'][0]->special_services==1) { $specialDisplay = 'block';  }  else { $specialDisplay = 'none'; }
                                        //   if($memberInfo['data'][0]->production_talent==1) { $productionDisplay = 'block';  }  else { $productionDisplay = 'none'; }
                                        //    if($memberInfo['data'][0]->djtype_commercialreporting==1) { $commercialDisplay = 'block';  }  else { $commercialDisplay = 'none'; }
                                        //    if($memberInfo['data'][0]->djtype_commercialnonreporting==1) { $nonCommercialDisplay = 'block';  }  else { $nonCommercialDisplay = 'none'; }
                                        //    if($memberInfo['data'][0]->djtype_club==1) { $clubDisplay = 'block';  }  else { $clubDisplay = 'none'; }
                                        //    if($memberInfo['data'][0]->djtype_mixtape==1) { $mixtapeDisplay = 'block';  }  else { $mixtapeDisplay = 'none'; }
                                        //    if($memberInfo['data'][0]->djtype_satellite==1) { $satelliteDisplay = 'block';  }  else { $satelliteDisplay = 'none'; }
                                        //    if($memberInfo['data'][0]->djtype_internet==1) { $internetDisplay = 'block';  }  else { $internetDisplay = 'none'; }
                                        //    if($memberInfo['data'][0]->djtype_college==1) { $collegeDisplay = 'block';  }  else { $collegeDisplay = 'none'; }
                                        //    if($memberInfo['data'][0]->djtype_pirate==1) { $pirateDisplay = 'block';  }  else { $pirateDisplay = 'none'; }    
                                        //    if($memberInfo['data'][0]->djwith_mp3==1) { $mp3Display = 'block';  }  else { $mp3Display = 'none'; } 
                                        //    if($memberInfo['data'][0]->djwith_cd==1) { $cdDisplay = 'block';  }  else { $cdDisplay = 'none';  }   
                                        //    if($memberInfo['data'][0]->djwith_vinyl==1) { $vinylDisplay = 'block';  }  else { $vinylDisplay = 'none'; }                                
                                        ?>
                                        <!--                           <div class="checkbox">-->
                                        <!--                                            <label>-->
                                        <!--    <input type="checkbox" name="dj_mixer" id="dj_mixer" value="1" onclick="getDiv('djDiv',this.id)"  class="ace" <?php if ($memberInfo['data'][0]->dj_mixer == 1) { ?> checked="checked" <?php } ?> />-->
                                        <!--                                                <span class="lbl"> DJ / Mixer</span>-->
                                        <!--                                            </label>-->
                                        <!--                                        </div>-->
                                        <!--                                        <div class="checkbox">-->
                                        <!--                                            <label>-->
                                        <!--<input type="checkbox" name="radio_station" id="radio_station" value="1" onclick="getDiv('radioDiv',this.id)" class="ace" <?php if ($memberInfo['data'][0]->radio_station == 1) { ?> checked="checked" <?php } ?> />-->
                                        <!--                                                <span class="lbl"> Radio Station (Non - DJ/Mixer)</span>-->
                                        <!--                                            </label>-->
                                        <!--                                        </div>-->
                                        <!--                                        <div class="checkbox">-->
                                        <!--                                          <label>-->
                                        <!--    <input type="checkbox" name="mass_media" id="mass_media" value="1" onclick="getDiv('massDiv',this.id)" class="ace" <?php if ($memberInfo['data'][0]->mass_media == 1) { ?> checked="checked" <?php } ?> />-->
                                        <!--                                                <span class="lbl"> Mass Media</span>-->
                                        <!--                                            </label>-->
                                        <!--                                        </div>-->
                                        <!--                                        <div class="checkbox">-->
                                        <!--                                            <label>-->
                                        <!--<input type="checkbox" name="record_label" id="record_label" value="1" onclick="getDiv('recordDiv',this.id)" class="ace" <?php if ($memberInfo['data'][0]->record_label == 1) { ?> checked="checked" <?php } ?> />-->
                                        <!--                                                <span class="lbl">Record Label</span>-->
                                        <!--                                            </label>-->
                                        <!--                                        </div>-->
                                        <!--                                        <div class="checkbox">-->
                                        <!--                                        <label>-->
                                        <!--    <input type="checkbox" name="management" id="management" value="1" onclick="getDiv('managementDiv',this.id)" class="ace" <?php if ($memberInfo['data'][0]->management == 1) { ?> checked="checked" <?php } ?> />-->
                                        <!--                                                <span class="lbl">Management</span>-->
                                        <!--                                            </label>-->
                                        <!--                                        </div>-->
                                        <!--                                        <div class="checkbox">-->
                                        <!--                                            <label>-->
                                        <!--    <input type="checkbox" name="clothing_apparel" id="clothing_apparel" onclick="getDiv('clothingDiv',this.id)"  value="1" class="ace" <?php if ($memberInfo['data'][0]->clothing_apparel == 1) { ?> checked="checked" <?php } ?> />-->
                                        <!--                                                <span class="lbl">Clothing/Apparel</span>-->
                                        <!--                                            </label>-->
                                        <!--                                        </div>-->
                                        <!--                                        <div class="checkbox">-->
                                        <!--                                        <label>-->
                                        <!--<input type="checkbox" name="promoter" id="promoter" onclick="getDiv('promoterDiv',this.id)" value="1" class="ace" <?php if ($memberInfo['data'][0]->promoter == 1) { ?> checked="checked" <?php } ?> />-->
                                        <!--                                                <span class="lbl">Promoter</span>-->
                                        <!--                                            </label>-->
                                        <!--                                        </div>-->
                                        <!--                                        <div class="checkbox">-->
                                        <!--                                            <label>-->
                                        <!--    <input type="checkbox" name="special_services" id="special_services" onclick="getDiv('specialDiv',this.id)" value="1" class="ace" <?php if ($memberInfo['data'][0]->special_services == 1) { ?> checked="checked" <?php } ?> />-->
                                        <!--                                                <span class="lbl">Special Services</span>-->
                                        <!--                                            </label>-->
                                        <!--                                        </div>-->
                                        <!--                                        <div class="checkbox">-->
                                        <!--                                        <label>-->
                                        <!--    <input type="checkbox" name="production_talent" id="production_talent" value="1" onclick="getDiv('productionDiv',this.id)" class="ace" <?php if ($memberInfo['data'][0]->production_talent == 1) { ?> checked="checked" <?php } ?> />-->
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <div class="form-group ">
                                                <label>How did you hear about Digiwaxx?</label>
                                                <div>
                                                    <select name="howheard" id="howheard" class="input form-control" onchange="howHeard()">
                                        ...
                                        <div class="form-group" id="howHeardDiv" style="display:<?php echo $howDisplay; ?>">
                                            <label>Name</label>
                                            <div>
                                                <input name="howheardvalue" class="form-control" id="howheardvalue" placeholder="Name" size="25" maxlength="255" value="<?php echo urldecode($memberInfo['data'][0]->howheardvalue); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <?php
                                    ...
                                    if ($memberInfo['data'][0]->djtype_club == 1 || $memberInfo['data'][0]->dj_mixer == 1) {
                                        $clubDisplay = 'block';
                                    } else {
                                        $clubDisplay = 'none';
                                    }
                                    ...
                                    <!-- <div id="djDiv" style="display:<?php # if (!empty($djDisplay)) echo $djDisplay; ?>"> -->
                                        <!-- <div class="row"> -->
                                            ...
                                            <div class="col-sm-9">
                                                <!--div class="checkbox">
                                        <label>
                                           <input type="checkbox" name="djtype_commercialreporting" id="djtype_commercialreporting" value="1" class="ace" <?php if ($memberInfo['data'][0]->djtype_commercialreporting == 1) { ?> checked="checked" <?php } ?> onclick="getDiv('mixShowDjDiv',this.id)" />
                                           <span class="lbl"> Commercial/Mixshow DJ (Reporting)</span>
                                        </label>
                                     </div>
                                     <div class="checkbox">
                                        <label>
                                           <input type="checkbox" name="djtype_commercialnonreporting" id="djtype_commercialnonreporting" value="1" class="ace" <?php if ($memberInfo['data'][0]->djtype_commercialnonreporting == 1) { ?> checked="checked" <?php } ?> onclick="getDiv('mixShowDjNonDiv',this.id)" />
                                           <span class="lbl"> Commercial/Mixshow DJ (Non-Reporting)</span>
                                        </label>
                                     </div-->
                                                <!--div class="checkbox">
                                        <label>
                                           <input type="checkbox" name="djtype_mixtape" id="djtype_mixtape" value="1" class="ace" <?php if ($memberInfo['data'][0]->djtype_mixtape == 1) { ?> checked="checked" <?php } ?> onclick="getDiv('mixTapeDjDiv',this.id)" />
                                           <span class="lbl">Mix Tape DJ</span>
                                        </label>
                                     </div>
                                     <div class="checkbox">
                                        <label>
                                           <input type="checkbox" name="djtype_satellite" id="djtype_satellite" value="1" class="ace" <?php if ($memberInfo['data'][0]->djtype_satellite == 1) { ?> checked="checked" <?php } ?> onclick="getDiv('satelliteRadioDjDiv',this.id)" />
                                           <span class="lbl">Satellite Radio DJ</span>
                                        </label>
                                     </div>
                                     <div class="checkbox">
                                        <label>
                                           <input type="checkbox" name="djtype_internet" id="djtype_internet" value="1" class="ace" <?php if ($memberInfo['data'][0]->djtype_internet == 1) { ?> checked="checked" <?php } ?> onclick="getDiv('internetRadioDjDiv',this.id)" />
                                           <span class="lbl">Internet Radio DJ</span>
                                        </label>
                                     </div>
                                     <div class="checkbox">
                                        <label>
                                           <input type="checkbox" name="djtype_college" id="djtype_college" value="1" class="ace" <?php if ($memberInfo['data'][0]->djtype_college == 1) { ?> checked="checked" <?php } ?> onclick="getDiv('collegeRadioDiv',this.id)" />
                                           <span class="lbl">College Radio</span>
                                        </label>
                                     </div>
                                     <div class="checkbox">
                                        <label>
                                           <input type="checkbox" name="djtype_pirate" id="djtype_pirate" value="1" class="ace" <?php if ($memberInfo['data'][0]->djtype_pirate == 1) { ?> checked="checked" <?php } ?> onclick="getDiv('pirateRadioDiv',this.id)" />
                                    ...
                                    <div class="row">
                                            <div class="col-sm-4 form-group">
                                                <label class="control-label no-padding-right" for="form-field-1"> What Is your Field?<br />
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="control-group">
                                                        <div class="checkbox form-group">
                                                            <label class="req-label-dj-dis">
                                                                <input type="checkbox" name="dj_mixer" id="djtype_club" value="1" class="ace" <?php if ($memberInfo['data'][0]->dj_mixer == 1) { ?> checked="checked" <?php } ?> onclick="getDiv('clubDjDiv',this.id)"/>
                                                                <span class="lbl">DJ/Mixer</span>
                                                            </label>
                                                            &nbsp;
                                                            <label class="req-label-dj-dis">
                                                                <input type="checkbox" value="1" name="radio_station" id="radio_station" <?php if ($memberInfo['data'][0]->radio_station == 1) { ?> checked="checked" <?php } ?> onclick="getDiv('radioDiv',this.id)" /> Radio Station (Non-DJ/Mixer) 
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div id="clubDjDiv" style="display:<?php echo $clubDisplay; ?>;">
                                        <div class="row">
                                            <div class="dash-heading">
                                                <h3 class="header smaller lighter blue">DJ/Mixer Information</h3>
                                            </div>
                                            <div class="col-sm-3"><label>Club DJ</label> </div>
                                            <div class="col-sm-9">
                                                <div class="col-sm-4"> <label>Club Name</label> </div>
                                                <div class="col-sm-8 form-group">
                                                    <input name="clubdj_clubname" class="form-control input" placeholder="Club Name" type="text" value="<?php echo $memberInfo['data'][0]->clubdj_clubname; ?>">
                                                </div>
                                                <div class="col-sm-4"> <label>Estimated Venue Capacity</label> </div>
                                                <div class="col-sm-8 form-group">
                                                    <input name="clubdj_capacity" class="form-control input" placeholder="Estimated Venue Capacity" type="text" value="<?php echo $memberInfo['data'][0]->clubdj_capacity; ?>">
                                                </div>
                                                <div class="col-sm-4"> <label>Party Format</label> </div>
                                                <div class="col-sm-8 form-group">
                                                    <span class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="clubdj_hiphop" value="1" class="ace" <?php if ($memberInfo['data'][0]->clubdj_hiphop == 1) { ?> checked="checked" <?php } ?> />
                                                            <span class="lbl"> Hip Hop</span>
                                                        </label>
                                                    </span>
                                                    <span class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="clubdj_rb" value="1" class="ace" <?php if ($memberInfo['data'][0]->clubdj_rb == 1) { ?> checked="checked" <?php } ?> />
                                                            <span class="lbl">R&B</span>
                                                        </label>
                                                    </span>
                                                    <span class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="clubdj_pop" value="1" class="ace" <?php if ($memberInfo['data'][0]->clubdj_pop == 1) { ?> checked="checked" <?php } ?> />
                                                            <span class="lbl">Pop/Top 40</span>
                                                        </label>
                                                    </span>
                                                    <span class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="clubdj_reggae" value="1" class="ace" <?php if ($memberInfo['data'][0]->clubdj_reggae == 1) { ?> checked="checked" <?php } ?> />
                                                            <span class="lbl">Reggae</span>
                                                        </label>
                                                    </span>
                                                    <span class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="clubdj_house" value="1" class="ace" <?php if ($memberInfo['data'][0]->clubdj_house == 1) { ?> checked="checked" <?php } ?> />
                                                            <span class="lbl">House</span>
                                                        </label>
                                                    </span>
                                                    <span class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="clubdj_calypso" value="1" class="ace" <?php if ($memberInfo['data'][0]->clubdj_calypso == 1) { ?> checked="checked" <?php } ?> />
                                                            <span class="lbl">Calypso/Soca</span>
                                                        </label>
                                                    </span>
                                                    <span class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="clubdj_rock" value="1" class="ace" <?php if ($memberInfo['data'][0]->clubdj_rock == 1) { ?> checked="checked" <?php } ?> />
                                                            <span class="lbl">Rock</span>
                                                        </label>
                                                    </span>
                                                    <span class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="clubdj_techno" value="1" class="ace" <?php if ($memberInfo['data'][0]->clubdj_techno == 1) { ?> checked="checked" <?php } ?> />
                                                            <span class="lbl"> Techno</span>
                                                        </label>
                                                    </span>
                                                    <span class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="clubdj_trance" value="1" class="ace" <?php if ($memberInfo['data'][0]->clubdj_trance == 1) { ?> checked="checked" <?php } ?> />
                                                            <span class="lbl">Trance</span>
                                                        </label>
                                                    </span>
                                                    <span class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="clubdj_afro" value="1" class="ace" <?php if ($memberInfo['data'][0]->clubdj_afro == 1) { ?> checked="checked" <?php } ?> />
                                                            <span class="lbl">Afro-Beat</span>
                                                        </label>
                                                    </span>
                                                    <span class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="clubdj_reggaeton" value="1" class="ace" <?php if ($memberInfo['data'][0]->clubdj_reggaeton == 1) { ?> checked="checked" <?php } ?> />
                                                            <span class="lbl">Reggaeton</span>
                                                        </label>
                                                    </span>
                                                    <span class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="clubdj_gogo" value="1" class="ace" <?php if ($memberInfo['data'][0]->clubdj_gogo == 1) { ?> checked="checked" <?php } ?> />
                                                            <span class="lbl">Go-Go</span>
                                                        </label>
                                                    </span>
                                                    <span class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="clubdj_neosoul" value="1" class="ace" <?php if ($memberInfo['data'][0]->clubdj_neosoul == 1) { ?> checked="checked" <?php } ?> />
                                                            <span class="lbl">Neo-Soul</span>
                                                        </label>
                                                    </span>
                                                    <span class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="clubdj_oldschool" value="1" class="ace" <?php if ($memberInfo['data'][0]->clubdj_oldschool == 1) { ?> checked="checked" <?php } ?> />
                                                            <span class="lbl">Old School</span>
                                                        </label>
                                                    </span>
                                                    <span class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="clubdj_electronic" value="1" class="ace" <?php if ($memberInfo['data'][0]->clubdj_electronic == 1) { ?> checked="checked" <?php } ?> />
                                                            <span class="lbl">Electronic</span>
                                                        </label>
                                                    </span>
                                                    <span class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="clubdj_latin" value="1" class="ace" <?php if ($memberInfo['data'][0]->clubdj_latin == 1) { ?> checked="checked" <?php } ?> />
                                                            <span class="lbl">Latin Soul</span>
                                                        </label>
                                                    </span>
                                                    <span class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="clubdj_dance" value="1" class="ace" <?php if ($memberInfo['data'][0]->clubdj_dance == 1) { ?> checked="checked" <?php } ?> />
                                                            <span class="lbl">Electronica/Dance</span>
                                                        </label>
                                                    </span>
                                                    <span class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="clubdj_jazz" value="1" class="ace" <?php if ($memberInfo['data'][0]->clubdj_jazz == 1) { ?> checked="checked" <?php } ?> />
                                                            <span class="lbl">Jazz</span>
                                                        </label>
                                                    </span>
                                                    <span class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="clubdj_country" value="1" class="ace" <?php if ($memberInfo['data'][0]->clubdj_country == 1) { ?> checked="checked" <?php } ?> />
                                                            <span class="lbl">Country</span>
                                                        </label>
                                                    </span>
                                                    <span class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="clubdj_world" value="1" class="ace" <?php if ($memberInfo['data'][0]->clubdj_world == 1) { ?> checked="checked" <?php } ?> />
                                                ...
                                                <div class="col-sm-8 form-group">
                                                    <span class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="clubdj_monday" value="1" class="ace" <?php if ($memberInfo['data'][0]->clubdj_monday == 1) { ?> checked="checked" <?php } ?> />
                                                            <span class="lbl">Monday</span>
                                                        </label>
                                                    </span>
                                                    <span class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="clubdj_tuesday" value="1" class="ace" <?php if ($memberInfo['data'][0]->clubdj_tuesday == 1) { ?> checked="checked" <?php } ?> />
                                                            <span class="lbl">Tuesday</span>
                                                        </label>
                                                    </span>
                                                    <span class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="clubdj_wednesday" value="1" class="ace" <?php if ($memberInfo['data'][0]->clubdj_wednesday == 1) { ?> checked="checked" <?php } ?> />
                                                            <span class="lbl">Wednesday</span>
                                                        </label>
                                                    </span>
                                                    <span class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="clubdj_thursday" value="1" class="ace" <?php if ($memberInfo['data'][0]->clubdj_thursday == 1) { ?> checked="checked" <?php } ?> />
                                                            <span class="lbl">Thursday</span>
                                                        </label>
                                                    </span>
                                                    <span class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="clubdj_friday" value="1" class="ace" <?php if ($memberInfo['data'][0]->clubdj_friday == 1) { ?> checked="checked" <?php } ?> />
                                                            <span class="lbl">Friday</span>
                                                        </label>
                                                    </span>
                                                    <span class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="clubdj_saturday" value="1" class="ace" <?php if ($memberInfo['data'][0]->clubdj_saturday == 1) { ?> checked="checked" <?php } ?> />
                                                            <span class="lbl">Saturday</span>
                                                        </label>
                                                    </span>
                                                    <span class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="clubdj_sunday" value="1" class="ace" <?php if ($memberInfo['data'][0]->clubdj_sunday == 1) { ?> checked="checked" <?php } ?> />
                                                            <span class="lbl">Sunday</span>
                                                        </label>
                                                    </span>
                                                    <span class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="clubdj_varies" value="1" class="ace" <?php if ($memberInfo['data'][0]->clubdj_varies == 1) { ?> checked="checked" <?php } ?> />
                                                ...
                                                <div class="col-sm-8 form-group">
                                                    <input name="clubdj_city" class="form-control input" placeholder="City" type="text" <?php if (isset($memberInfo['data'][0]->clubdj_city)) { ?> value="<?php echo $memberInfo['data'][0]->clubdj_city; ?>" <?php } ?>>
                                                </div>
                                                <div class="col-sm-4"> <label>State</label> </div>
                                                <div class="col-sm-8 form-group">
                                                    <input name="clubdj_state" class="form-control input" placeholder="State" type="text" <?php if (isset($memberInfo['data'][0]->clubdj_state)) { ?> value="<?php echo $memberInfo['data'][0]->clubdj_state; ?>" <?php } ?>>
                                                </div>
                                                <div class="col-sm-4"> <label>Country</label> </div>
                                                <div class="col-sm-8 form-group">
                                                    <input name="clubdj_intcountry" class="form-control input" placeholder="Country Name" type="text" <?php if (isset($memberInfo['data'][0]->clubdj_intcountry)) { ?> value="<?php echo $memberInfo['data'][0]->clubdj_intcountry; ?>" <?php } ?>>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

                                    <div id="radioDiv" style="display:<?php if (!empty($radioDisplay)) echo $radioDisplay; ?>">
                                        <div class="row">
                                            <div class="dash-heading">
                                                <h3 class="header smaller lighter blue">Radio Station Information (Non-DJ/Mixer)</h3>
                                            </div>
                                            <div class="col-3"><label>Radio Station</label> </div>
                                            <div class="col-9">
                                                <div class="form-group">
                                                    <label class="col-sm-4">Station Name</label>
                                                        <div class="col-sm-8">
                                                            <input name="stationName" class="form-control input" size="20" value="<?php if(isset($radio['data'][0]->stationname)) { echo $radio['data'][0]->stationname; } ?>"placeholder="Station Name" type="text" />
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label class="col-sm-4">Station Call Letters</label>
                                                    <div class="col-sm-8">
                                                        <input name="stationCall" class="form-control input" size="20" value="<?php if(isset($radio['data'][0]->stationcallletters)) { echo $radio['data'][0]->stationcallletters; } ?>" placeholder="Station Call Letters" type="text" />
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label class="col-sm-4">Station Frequency</label>
                                                    <div class="col-sm-8">
                                                        <input name="stationFrequency" class="form-control input" size="20" value="<?php if(isset($radio['data'][0]->stationfrequency)) { echo $radio['data'][0]->stationfrequency; } ?>" placeholder="Station Frequency" type="text" />
                                                    </div>
                                                </div>
                                        ...
                                        <div id="musicInnerDiv" style="display:<?php echo $musicInnerDivDisplay; ?>;">
                                            <?php //echo '<pre>';print_r($memberInfo);die(); 
                                            ?>
                                            <hr>
                                            <div class="row">
                                    ...
                                    <!--            <div class="checkbox">-->
                                    <!--                <label>-->
                                    <!--                    <input type="checkbox" name="djtype_club" id="djtype_club" value="1" class="ace" <?php if ($memberInfo['data'][0]->djtype_club == 1) { ?> checked="checked" <?php } ?> onclick="getDiv('clubDjDiv',this.id)" />-->
                                    ...
                                    <!--            <div class="checkbox">-->
                                    <!--                <label>-->
                                    <!--                    <input type="checkbox" name="djwith_mp3" value="1" class="ace" <?php if ($memberInfo['data'][0]->djwith_mp3 == 1) { ?> checked="checked" <?php } ?> id="djwith_mp3" onclick="getDiv('mp3Div',this.id)" />-->
                                    <!--                    <span class="lbl"> MP3</span>-->
                                    <!--                </label>-->
                                    <!--            </div>-->
                                    <!--            <div id="mp3Div" style="display:<?php if (!empty($mp3Display)) echo $mp3Display; ?>;">-->
                                    <!--                <div class="checkbox">-->
                                    <!--                    <label>-->
                                    <!--                        <input type="checkbox" name="djwith_mp3_serato" value="1" class="ace" <?php if ($memberInfo['data'][0]->djwith_mp3_serato == 1) { ?> checked="checked" <?php } ?> />-->
                                    <!--                        <span class="lbl"> Serato Scratch</span>-->
                                    <!--                    </label>-->
                                    <!--                </div>-->
                                    <!--                <div class="checkbox">-->
                                    <!--                    <label>-->
                                    <!--                        <input type="checkbox" name="djwith_mp3_final" value="1" class="ace" <?php if ($memberInfo['data'][0]->djwith_mp3_final == 1) { ?> checked="checked" <?php } ?> />-->
                                    <!--                        <span class="lbl">Final Scratch Pro</span>-->
                                    <!--                    </label>-->
                                    <!--                </div>-->
                                    <!--                <div class="checkbox">-->
                                    <!--                    <label>-->
                                    <!--                        <input type="checkbox" name="djwith_mp3_pcdj" value="1" class="ace" <?php if ($memberInfo['data'][0]->djwith_mp3_pcdj == 1) { ?> checked="checked" <?php } ?> />-->
                                    <!--                        <span class="lbl">PCDJ</span>-->
                                    <!--                    </label>-->
                                    <!--                </div>-->
                                    <!--                <div class="checkbox">-->
                                    <!--                    <label>-->
                                    <!--                        <input type="checkbox" name="djwith_mp3_ipod" value="1" class="ace" <?php if ($memberInfo['data'][0]->djwith_mp3_ipod == 1) { ?> checked="checked" <?php } ?> />-->
                                    <!--                        <span class="lbl"> I-Pod</span>-->
                                    <!--                    </label>-->
                                    <!--                </div>-->
                                    <!--                <div class="checkbox">-->
                                    <!--                    <label>-->
                                    <!--                        <input type="checkbox" name="djwith_mp3_other" value="1" class="ace" <?php if ($memberInfo['data'][0]->djwith_mp3_other == 1) { ?> checked="checked" <?php } ?> />-->
                                    ...
                                    <!--            <div class="checkbox">-->
                                    <!--                <label>-->
                                    <!--                    <input type="checkbox" name="djwith_cd" value="1" class="ace" <?php if ($memberInfo['data'][0]->djwith_cd == 1) { ?> checked="checked" <?php } ?> id="djwith_cd" onclick="getDiv('cdDiv',this.id)" />-->
                                    <!--                    <span class="lbl">CD</span>-->
                                    <!--                </label>-->
                                    <!--            </div>-->
                                    <!--            <div id="cdDiv" style="display:<?php if (!empty($cdDisplay)) echo $cdDisplay; ?>;">-->
                                    <!--                <div class="checkbox">-->
                                    <!--                    <label>-->
                                    ...
                                    <!--            <div class="checkbox">-->
                                    <!--                <label>-->
                                    <!--                    <input type="checkbox" name="djwith_vinyl" value="1" class="ace" <?php if ($memberInfo['data'][0]->djwith_vinyl == 1) { ?> checked="checked" <?php } ?> id="djwith_vinyl" onclick="getDiv('vinylDiv',this.id)" />-->
                                    <!--                    <span class="lbl">Vinyl</span>-->
                                    <!--                </label>-->
                                    <!--            </div>-->
                                    <!--            <div id="vinylDiv" style="display:<?php if (!empty($vinylDisplay)) echo $vinylDisplay; ?>;">-->
                                    <!--                <div class="checkbox">-->
                                    <!--                    <label>-->
                                    ...
                                    <!--    </div>-->
                                    <!--Mix show DJ-->
                                    <!--    <div id="mixShowDjDiv" style="display:<?php if (!empty($commercialDisplay)) echo $commercialDisplay; ?>;">-->
                                    ...
                                    <!--Mix show dj ends-->
                                    <!--Mix show DJ non-->
                                    <!--    <div id="mixShowDjNonDiv" style="display:<?php if (!empty($nonCommercialDisplay)) echo $nonCommercialDisplay; ?>;">-->
                                    ...
                                    <!--Club DJ-->
                                    <!--    <div id="clubDjDiv" style="display:<?php if (!empty($clubDisplay)) echo $clubDisplay; ?>;">-->
                                    <!--        <div class="form-group">-->
                                    <!--            <label class="col-sm-3">Club DJ</label>-->
                                    <!--            <div class="col-sm-9">-->
                                    <!--                <label class="col-sm-3">Club Name</label>-->
                                    <!--                <div class="col-sm-9 form-group">-->
                                    <!--                    <input name="clubdj_clubname" class="form-control input" size="20" placeholder="Club Name" type="text" value="<?php echo $memberInfo['data'][0]->clubdj_clubname; ?>">-->
                                    <!--                </div>-->
                                    <!--                <div style="clear:both;"></div>-->
                                    <!--                <label class="col-sm-3">Estimated Venue Capacity</label>-->
                                    <!--                <div class="col-sm-9 form-group">-->
                                    <!--                    <input name="clubdj_capacity" class="form-control input" size="20" placeholder="Estimated Venue Capacity" type="text" value="<?php echo $memberInfo['data'][0]->clubdj_capacity; ?>">-->
                                    <!--                </div>-->
                                    <!--                <div style="clear:both;"></div>-->
                                    ...
                                    <!--                <div class="col-sm-9 form-group">-->
                                    <!--                    <input name="clubdj_city" class="form-control input" size="20" placeholder="City" type="text" <?php if (isset($memberInfo['data'][0]->clubdj_city)) { ?> value="<?php echo $memberInfo['data'][0]->clubdj_city; ?>" <?php } ?>>-->
                                    <!--                </div>-->
                                    <!--                <div style="clear:both;"></div>-->
                                    <!--                <label class="col-sm-3">State</label>-->
                                    <!--                <div class="col-sm-9 form-group">-->
                                    <!--                    <input name="clubdj_state" class="form-control input" size="20" placeholder="State" type="text" <?php if (isset($memberInfo['data'][0]->clubdj_state)) { ?> value="<?php echo $memberInfo['data'][0]->clubdj_state; ?>" <?php } ?>>-->
                                    <!--                </div>-->
                                    <!--                <div style="clear:both;"></div>-->
                                    <!--                <label class="col-sm-3">Country</label>-->
                                    <!--                <div class="col-sm-9 form-group">-->
                                    <!--                    <input name="clubdj_intcountry" class="form-control input" size="20" placeholder="Country Name" type="text" <?php if (isset($memberInfo['data'][0]->clubdj_intcountry)) { ?> value="<?php echo $memberInfo['data'][0]->clubdj_intcountry; ?>" <?php } ?>>-->
                                    <!--                </div>-->
                                    <!--            </div>-->
                                    <!--        </div>-->
                                    <!--    </div>-->
                                    <!--club dj ends-->
                                    <!--Mix Tape DJ-->
                                    <!--    <div id="mixTapeDjDiv" style="display:<?php if (!empty($mixtapeDisplay)) echo $mixtapeDisplay; ?>">-->
                                    ...
                                    <!--    </div>-->
                                    <!--Mix tape dj ends-->
                                    <!--    <div id="satelliteRadioDjDiv" style="display:<?php if (!empty($satelliteDisplay)) echo $satelliteDisplay; ?>;">-->
                                    ...
                                    <!--Internet Radio DJ-->
                                    <!--    <div id="internetRadioDjDiv" style="display:<?php if (!empty($internetDisplay)) echo $internetDisplay; ?>;">-->
                                    ...
                                    <!--College Radio-->
                                    <!--    <div id="collegeRadioDiv" style="display:<?php if (!empty($collegeDisplay)) echo $collegeDisplay; ?>;">-->
                                    ...
                                    <!--College Radio ends-->
                                    <!--Pirate Radio-->
                                    <!--    <div id="pirateRadioDiv" style="display:<?php if (!empty($pirateDisplay)) echo $pirateDisplay; ?>;">-->
                                    ...
                                    <!--        <div class="col-sm-9">-->
                                    <!--            <input name="stationCall" class="form-control input" size="20" placeholder="First Name" type="text" <?php if (isset($radio['data'][0]->stationcallletters)) { ?> value="<?php echo $radio['data'][0]->stationcallletters; ?>" <?php } ?>>-->
                                    <!--        </div>-->
                                    <!--    </div>-->
                                    <!--    <div class="form-group">-->
                                    <!--        <label class="col-sm-3">Station Name</label>-->
                                    <!--        <div class="col-sm-9">-->
                                    <!--            <input name="stationName" class="form-control input" size="20" placeholder="First Name" type="text" <?php if (isset($radio['data'][0]->stationname)) { ?> value="<?php echo $radio['data'][0]->stationname; ?>" <?php } ?>>-->
                                    <!--        </div>-->
                                    <!--    </div>-->
                                    <!--    <div class="form-group">-->
                                    <!--        <label class="col-sm-3">Station Frequency</label>-->
                                    <!--        <div class="col-sm-9">-->
                                    <!--            <input name="stationFrequency" class="form-control input" size="20" placeholder="First Name" type="text" <?php if (isset($radio['data'][0]->stationfrequency)) { ?> value="<?php echo $radio['data'][0]->stationfrequency; ?>" <?php } ?>>-->
                                    <!--        </div>-->
                                    <!--    </div>-->
                                    ...
                                    <!--                <div>-->
                                    <!--                    <input name="musicCall" id="musicCall" class="form-control input" size="20" placeholder="First Name" type="text" <?php if (isset($radio['data'][0]->musicdirector_stationcallletters)) { ?> value="<?php echo $radio['data'][0]->musicdirector_stationcallletters; ?>" <?php } ?>>-->
                                    <!--                </div>-->
                                    <!--            </div>-->
                                    <!--            <div class="form-group">-->
                                    <!--                <label>Do You Host a Show?</label>-->
                                    <!--                <div>-->
                                    <!--                    <input name="musicHost" id="musicHost" class="form-control input" size="20" placeholder="First Name" type="text" <?php if (isset($radio['data'][0]->musicdirector_host)) { ?> value="<?php echo $radio['data'][0]->musicdirector_host; ?>" <?php } ?>>-->
                                    <!--                </div>-->
                                    <!--            </div>-->
                                    <!--            <div class="form-group">-->
                                    <!--                <label>Show Name</label>-->
                                    <!--                <div>-->
                                    <!--                    <input name="musicName" id="musicName" class="form-control input" size="20" placeholder="First Name" type="text" <?php if (isset($radio['data'][0]->musicdirector_showname)) { ?> value="<?php echo $radio['data'][0]->musicdirector_showname; ?>" <?php } ?>>-->
                                    <!--                </div>-->
                                    <!--            </div>-->
                                    <!--            <div class="form-group">-->
                                    ...
                                    <!--                <div>-->
                                    <!--                    <input name="musicTime" id="musicTime" class="form-control input" size="20" placeholder="First Name" type="text" <?php if (isset($radio['data'][0]->musicdirector_showtime)) { ?> value="<?php echo $radio['data'][0]->musicdirector_showtime; ?>" <?php } ?>>-->
                                    <!--                </div>-->
                                    <!--            </div>-->
                                    <!--        </div>-->
                                    <!--    </div>-->
                                    ...
                                    <!--                <label>Music Call Times</label>-->
                                    <!--                <div>-->
                                    <!--                    <input name="programCall" id="programCall" class="form-control input" size="20" placeholder="First Name" type="text" <?php if (isset($radio['data'][0]->programdirector_stationcallletters)) { ?> value="<?php echo $radio['data'][0]->programdirector_stationcallletters; ?>" <?php } ?>>-->
                                    <!--                </div>-->
                                    <!--            </div>-->
                                    <!--            <div class="form-group">-->
                                    <!--                <label>Do You Host a Show?</label>-->
                                    <!--                <div>-->
                                    <!--                    <input name="programHost" id="programHost" class="form-control input" size="20" placeholder="First Name" type="text" <?php if (isset($radio['data'][0]->programdirector_host)) { ?> value="<?php echo $radio['data'][0]->programdirector_host; ?>" <?php } ?>>-->
                                    <!--                </div>-->
                                    <!--            </div>-->
                                    <!--            <div class="form-group">-->
                                    <!--                <label>Show Name</label>-->
                                    <!--                <div>-->
                                    <!--                    <input name="programName" id="programName" class="form-control input" size="20" placeholder="First Name" type="text" <?php if (isset($radio['data'][0]->programdirector_showname)) { ?> value="<?php echo $radio['data'][0]->programdirector_showname; ?>" <?php } ?>>-->
                                    <!--                </div>-->
                                    <!--            </div>-->
                                    <!--            <div class="form-group">-->
                                    <!--                <label>Show Days</label>-->
                                    ...
                                    <!--                <label>Show Time/s</label>-->
                                    <!--                <div>-->
                                    <!--                    <input name="programTime" id="programTime" class="form-control input" size="20" placeholder="First Name" type="text" <?php if (isset($radio['data'][0]->programdirector_showtime)) { ?> value="<?php echo $radio['data'][0]->programdirector_showtime; ?>" <?php } ?>>-->
                                    <!--                </div>-->
                                    <!--            </div>-->
                                    <!--        </div>-->
                                    <!--    </div>-->
                                    ...
                                    <!--                <label>Show Name</label>-->
                                    <!--                <div>-->
                                    <!--                    <input name="airName" id="airName" class="form-control input" size="20" placeholder="First Name" type="text" <?php if (isset($radio['data'][0]->onairpersonality_showname)) { ?> value="<?php echo $radio['data'][0]->onairpersonality_showname; ?>" <?php } ?>>-->
                                    <!--                </div>-->
                                    <!--            </div>-->
                                    <!--            <div class="form-group">-->
                                    <!--                <label>Show Days</label>-->
                                    ...
                                    <!--                <label>Show Time/s</label>-->
                                    <!--                <div>-->
                                    <!--                    <input name="airTime" id="airTime" class="form-control input" size="20" placeholder="First Name" type="text" <?php if (isset($radio['data'][0]->onairpersonality_showtime)) { ?> value="<?php echo $radio['data'][0]->onairpersonality_showtime; ?>" <?php } ?>>-->
                                    <!--                </div>-->
                                    <!--            </div>-->
                                    <!--        </div>-->
                                    <!--    </div>-->
                                    ...
                                    <!--</div>-->
                                    <!--radio div ends-->
                                    <!--<div id="massDiv" style="display:<?php if (!empty($massDisplay)) echo $massDisplay; ?>">-->
                                    <!--    <h3>Mass Media Information</h3>-->
                                    <!--    <div class="form-group">-->
                                    <!--        <label class="col-sm-3">Company Name</label>-->
                                    <!--        <div class="col-sm-9">-->
                                    <!--            <input name="massName" id="massName" class="form-control input" size="20" type="text" <?php if (isset($media['data'][0]->media_name)) { ?> value="<?php echo $media['data'][0]->media_name; ?>" <?php } ?>>-->
                                    <!--        </div>-->
                                    <!--    </div>-->
                                    <!--    <div class="form-group">-->
                                    ...
                                    <!--        <div class="col-sm-9">-->
                                    <!--            <input name="massDepartment" id="massDepartment" class="form-control input" size="20" type="text" <?php if (isset($media['data'][0]->media_department)) { ?> value="<?php echo $media['data'][0]->media_department; ?>" <?php } ?>>-->
                                    <!--        </div>-->
                                    <!--    </div>-->
                                    ...
                                    <!--        <div class="col-sm-9">-->
                                    <!--            <input name="massWebsite" id="massWebsite" class="form-control input" size="20" type="text" <?php if (isset($media['data'][0]->media_website)) { ?> value="<?php echo $media['data'][0]->media_website; ?>" <?php  } ?>>-->
                                    <!--        </div>-->
                                    <!--    </div>-->
                                    <!--</div>-->
                                    <!--mass div ends-->
                                    <!--<div id="recordDiv" style="display:<?php if (!empty($recordDisplay)) echo $recordDisplay; ?>">-->
                                    <!--    <h3>Record Label Information</h3>-->
                                    <!--    <div class="form-group">-->
                                    <!--        <label class="col-sm-3">Label Name</label>-->
                                    <!--        <div class="col-sm-9">-->
                                    <!--            <input name="recordName" id="recordName" class="form-control input" size="20" type="text" <?php if (isset($record['data'][0]->label_name)) { ?> value="<?php echo $record['data'][0]->label_name; ?>" <?php } ?>>-->
                                    <!--        </div>-->
                                    <!--    </div>-->
                                    <!--    <div class="form-group">-->
                                    ...
                                    <!--        <div class="col-sm-9">-->
                                    <!--            <input name="recordDepartment" id="recordDepartment" class="form-control input" size="20" type="text" <?php if (isset($record['data'][0]->label_department)) { ?> value="<?php echo $record['data'][0]->label_department; ?>" <?php } ?>>-->
                                    <!--        </div>-->
                                    <!--    </div>-->
                                    <!--</div>-->
                                    <!--record div ends-->
                                    <!--<div id="managementDiv" style="display:<?php if (!empty($managementDisplay)) echo $managementDisplay; ?>">-->
                                    <!--    <h3>Management</h3>-->
                                    <!--    <div class="form-group">-->
                                    <!--        <label class="col-sm-3">Management Name</label>-->
                                    <!--        <div class="col-sm-9">-->
                                    <!--            <input name="managementName" id="managementName" class="form-control input" size="20" type="text" <?php if (isset($management['data'][0]->management_name)) { ?> value="<?php echo $management['data'][0]->management_name; ?>" <?php } ?>>-->
                                    <!--        </div>-->
                                    <!--    </div>-->
                                    <!--    <div class="form-group">-->
                                    ...
                                    <!--            <div class="col-sm-9">-->
                                    <!--                <input name="managementWho" id="managementWho" class="form-control input" size="20" type="text" <?php if (isset($management['data'][0]->management_who)) { ?> value="<?php echo $management['data'][0]->management_who; ?>" <?php } ?>>-->
                                    <!--            </div>-->
                                    <!--        </div>-->
                                    <!--        <div class="form-group" id="managementIndustryDiv">-->
                                    <!--            <label class="col-sm-3">What Industry?</label>-->
                                    <!--            <div class="col-sm-9">-->
                                    <!--                <input name="managementIndustry" id="managementIndustry" class="form-control input" size="20" type="text" <?php if (isset($management['data'][0]->management_industry)) { ?> value="<?php echo $management['data'][0]->management_industry; ?>" <?php } ?>>-->
                                    <!--            </div>-->
                                    <!--        </div>-->
                                    <!--    </div>-->
                                    <!--</div>-->
                                    <!--managment div ends-->
                                    <!--<div id="clothingDiv" style="display:<?php if (!empty($clothingDisplay)) echo $clothingDisplay; ?>">-->
                                    <!--    <h3>Clothing/Apparel Information</h3>-->
                                    <!--    <div class="form-group">-->
                                    <!--        <label class="col-sm-3">Clothing/Apparel Name</label>-->
                                    <!--        <div class="col-sm-9">-->
                                    <!--            <input name="clothingName" id="clothingName" class="form-control input" size="20" type="text" <?php if (isset($clothing['data'][0]->clothing_name)) { ?> value="<?php echo $clothing['data'][0]->clothing_name; ?>" <?php } ?>>-->
                                    <!--        </div>-->
                                    <!--    </div>-->
                                    <!--    <div class="form-group" id="managementWhoDiv">-->
                                    <!--        <label class="col-sm-3">Clothing/Apparel Department</label>-->
                                    <!--        <div class="col-sm-9">-->
                                    <!--            <select name="clothingDepartment" id="clothingDepartment" class="input selectpicker" size="20" type="text">-->
                                    ...
                                    <!--</div>-->
                                    <!--clothing div ends-->
                                    <!--<div id="promoterDiv" style="display:<?php if (!empty($promoterDisplay)) echo $promoterDisplay; ?>">-->
                                    <!--    <h3>Promoter Information</h3>-->
                                    <!--    <div class="form-group">-->
                                    <!--        <label class="col-sm-3">Promotion Company Name</label>-->
                                    <!--        <div class="col-sm-9">-->
                                    <!--            <input name="promoterName" id="promoterName" class="form-control input" size="20" type="text" <?php if (isset($promoter['data'][0]->promoter_name)) { ?> value="<?php echo $promoter['data'][0]->promoter_name; ?>" <?php } ?>>-->
                                    <!--        </div>-->
                                    <!--    </div>-->
                                    <!--    <div class="form-group">-->
                                    <!--        <label class="col-sm-3">Type</label>-->
                                    ...
                                    <!--        <label class="col-sm-3">Department</label>-->
                                    <!--        <div class="col-sm-9">-->
                                    <!--            <select name="promoterDepartment" id="promoterDepartment" class="input selectpicker" size="20" type="text">-->
                                    ...
                                    <!--        <label class="col-sm-3">Company Website</label>-->
                                    <!--        <div class="col-sm-9">-->
                                    <!--            <input name="promoterWebsite" id="promoterWebsite" class="form-control input" size="20" type="text" <?php if (isset($promoter['data'][0]->promoter_website)) { ?> value="<?php echo $promoter['data'][0]->promoter_website; ?>" <?php } ?>>-->
                                    <!--        </div>-->
                                    <!--    </div>-->
                                    <!--</div>-->
                                    <!--promoter div ends-->
                                    <!--<div id="specialDiv" style="display:<?php if (!empty($specialDisplay)) echo $specialDisplay; ?>">-->
                                    ...
                                    <!--        <label class="col-sm-3"> Company Name</label>-->
                                    <!--        <div class="col-sm-9">-->
                                    <!--            <input name="specialName" id="specialName" class="form-control input" size="20" type="text" <?php if (isset($special['data'][0]->services_name)) { ?> value="<?php echo $special['data'][0]->services_name; ?>" <?php } ?>>-->
                                    <!--        </div>-->
                                    <!--    </div>-->
                                    <!--    <div class="form-group">-->
                                    <!--        <label class="col-sm-3"> Company Website</label>-->
                                    <!--        <div class="col-sm-9">-->
                                    <!--            <input name="specialWebsite" id="specialWebsite" class="form-control input" size="20" type="text" <?php if (isset($special['data'][0]->services_website)) { ?> value="<?php echo $special['data'][0]->services_website; ?>" <?php } ?>>-->
                                    <!--        </div>-->
                                    <!--    </div>-->
                                    <!--</div>-->
                                    <!--special div ends-->
                                    ...
                                    ?>
                                    <!--<div id="productionDiv" style="display:<?php if (!empty($productionDisplay)) echo $productionDisplay; ?>">-->
                                    ...
                                    <!--        <label class="col-sm-3"> Company Name</label>-->
                                    <!--        <div class="col-sm-9">-->
                                    <!--            <input name="productionName" id="productionName" class="form-control input" size="20" type="text" <?php if (isset($production['data'][0]->production_name)) { ?> value="<?php echo $production['data'][0]->production_name; ?>" <?php } ?>>-->
                                    <!--        </div>-->
                                    <!--    </div>-->
                                    <!--</div>-->
                                    <!--production div ends-->
                                    <div class="form-group text-right">
                                        <input type="submit" name="updateMember" value="Update Info" class="btn btn-theme btn-gradient" />
                                    </div>
                                </div>
                            </form>
                            <!-- eof mem-dblk -->
                    ...
                    <div class="album-d-sec">
                        ...
                        <div class="row">
                            <div class="col-md-12-cols col-sm-12 col-12">
                                <!--download tracks-->
                                        ...
                                        <div class="">
                                            <div class="row">
                                                        ...
                                                        <div class="col-md-5-cols col-sm-6 col-12">
                                                            <div class="album-download-box">
                                                                <a href="javascript:void(0);" onClick="changeTrack('<?php echo $var1; ?>','<?php echo $var2; ?>','<?php echo $var3; ?>','<?php echo $var4; ?>','<?php echo $var5; ?>','<?php echo $track->id; ?>')">
                                                                    <div class="album-img">
                                                                        <img src="<?php echo $src; ?>" style="" class="img-fluid">
                                                                    </div>
                                                                    ...
                                                                    <div class="download-detail">
                                                                        ...
                                                                        <h5><?php
                                                                            ...
                                                                            echo $artist;
                                                                            ?></h5>
                                                                        <div class="download-btn"><a href="<?php echo $href; ?>" class="dwd"><i class="fa fa-cloud-download"></i></a></div>
                                                                    </div>
                                                ...
                                                <span class="artist"><?php
                                                                        ...
                                                                        // 
                                                                        ?></span>
                                                <span class="dloads"><?php //echo $trackData[$track->id]['downloads']; 
                                                                        ?></span>
                                                <span class="dloadst">dloads</span>
                                            </span> -->
                                                                </a>
                                                                <!-- <a href="<?php //echo $href; 
                                                                                ?>" class="dwd"><i class="fa fa-cloud-download"></i></a> -->
                                                            </div>
                                                        </div>
                                                <?php }
                                                    $i++;
                        ...
                        <div class="album-d-more">
                            <a href="<?php echo url("member_staff_picks"); ?>">SEE MORE </a>
                        </div>
                    </div>
                    <!--album-download-->
                    <div class="album-d-sec">
                                                ...
                                                ?>
                                                        <div class="col-md-5-cols col-sm-6 col-12">
                                                            <div class="album-download-box">
                                                                <a href="javascript:void(0);" onClick="changeTrack('<?php echo $var1; ?>','<?php echo $var2; ?>','<?php echo $var3; ?>','<?php echo $var4; ?>','<?php echo $var5; ?>','<?php echo $track->id; ?>')">
                                                                    <div class="album-img">
                                                                        <img src="<?php echo $var5; ?>" width="" height="" style="" class="img-fluid">
                                                                    </div>
                                                                    <div class="download-detail">
                                                                        <h3><?php
                                                                            $album = strtoupper(urldecode($track->album));
                        ...
                        <div class="album-d-more">
                            <a href="<?php echo url("member_selected_for_you"); ?>">SEE MORE </a>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        setTimeout(function() {
            $('.dash-heading .success-msg').fadeOut(); // Hide success message
        }, 7000);
    });
    $(function() {
        $("#dob").datepicker({
...
<script>
    ...
    function validate() {
        ...
        if (!((reg.value == 'male') || (reg.value == 'female'))) {
