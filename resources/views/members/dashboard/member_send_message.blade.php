                                    ...
                                    <div class="col-lg-10 col-md-9 col-sm-9">
                                    	<div class="smsg mCustomScrollbar">
											<div class="form-group clearfix">
                                                ...
                                                <div class="text-right"><input  type="button" onclick="sendMessage()" class="mt-0 login_btn btn ems btn btn-gradient btn-theme" value="Send Message"></div>
                                    	    </div>
                                    ...
                                    ?>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                <div class="tdpic">
                                                    <a href="javascript:void(0);" onClick="changeTrack('<?php echo $var1; ?>','<?php echo $var2; ?>','<?php echo $var3; ?>','<?php echo $var4; ?>','<?php echo $var5; ?>','<?php echo $track->id; ?>')">
														<?php
														 if(isset($track->imgpage) && !empty($track->imgpage)){
														...
														?>
                                                        <img src="<?php echo $img_get; ?>" width="108" height="108" style="height:138px;" class="img-responsive">
