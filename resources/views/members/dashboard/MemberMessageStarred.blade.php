	...
	<section class="main-dash">
	 ...
	 <div class="dash-container">
                            ...
                            <div class="msg-con">
                            	<div class="row">
                                	<div class="col-lg-2 col-md-3 col-sm-3">
                                    	<div class="avatar">
                                        	<img src="<?php echo $clientImage; ?>"> <br>
                                            <?php echo $clientName; ?>                        
                                        </div>
                                    </div>
                                    	...
                                    	<div class="smsg mCustomScrollbar">
											<div class="form-group">
												...
												<div class="text-right">
                                                    <input  type="button" onclick="sendMessage()" class="login_btn btn btn-theme btn-gradient" value="Send Message">
                                                </div>
                                    	    </div>
	   ...
	   <span id="star<?php echo $message->messageId; ?>" class="<?php echo $starClass; ?>"  onclick="markStar('<?php echo $message->messageId; ?>')" title="Add to Favorite">
		...
		<span id="archive<?php echo $message->messageId; ?>" class="inactiveArchive" onclick="makeArchive('<?php echo $message->messageId; ?>')" title="Click to Remove">		
