           ...
           <div class="col-12">
            ...
            <div class="tabs-section"> 
				...
				<?php if($staffTracks['numRows']>0) { ?>      
				 <div class="stpk-blk">
					<div class="stpk-con mCustomScrollbar" style="height:900px; overflow-y:auto;">
						<div class="row">
				<?php 
				$i=1;
				...
				// 			$var3 = asset("AUDIO/".$mp3s[$track->id]['data'][0]->location);
				             $trackLocation = $mp3s[$track->id]['data'][0]->location;
                                                  ...
                                                  if (strpos($trackLocation, '.mp3') !== false) {
                                                      $var3 =url('Download_member_track?track=' . $trackLocation . '&mp3Id=' . $track->id . '&trackId=' . $mp3s[$track->id]['data'][0]->id . '&title=' . urldecode($track->title));
                                                  } else if ((int) $fileid) {
				...
				// 			$var5 = asset("public/ImagesUp/".$track->imgpage);
							...
							<div class="col-lg-3 col-md-4 col-sm-4 col-6">
								<div class="tdpic">
									<a href="javascript:void(0)" onclick="changeTrack('<?php echo $var1; ?>','<?php echo $var2; ?>','<?php echo $var3; ?>','<?php echo $var4; ?>','<?php  echo $var5; ?>','<?php echo $track->id; ?>')">
										<img src="<?php echo $img; ?>" width="108" height="108" style="height:138px;" class="img-responsive">
