	...
	<tr>
      ...
      <td width="754" valign="top" bgcolor="#EAEAEA" style="padding:9px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td colspan="2" valign="top" align="center"><a href="*link*"><img src="http://projectwaxx.com/assets/img/logo2.png" border="0"></a></td>
        </tr>
        <tr>
          <td colspan="2"><table width="500" border="0" align="center" cellpadding="2" cellspacing="2">
            <tr>
              <td width="100%" colspan="2" bgcolor="#D8D8D8"><font color="#333333" size="2" face="Arial, Helvetica, Verdana"><strong>*message*</strong></font></td>
            </tr>
            <tr bgcolor="#D8D8D8">
            ...
            <tr>
              <td colspan="2"><div align="center"><font size="1" face="Arial, Helvetica, Verdana"><strong><a href="http://gpdemoprojects.com/working/digiwaxx/Unsubscribe_member.php?id=*memberid*&key=*key*">Click Here to Unsubscribe
                from Digital Waxx Service</a><br>
                or paste this string in your browser window:<br>
                http://www.digiwaxx.com/Members/unsubscribe.php?id=*memberid*&key=*key*
              </strong></font></div></td>
            </tr>
            <tr>
