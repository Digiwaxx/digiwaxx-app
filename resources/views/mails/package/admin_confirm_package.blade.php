                ...
                <tr>
                    <td style="padding: 40px 30px 0px;">
                        <table  style="width: 100%;  border-collapse:separate; border-spacing:03px 03px; font-size: 14px;">
                            <tr>
                              <td colspan="2" style="background:#2c3242; color:#53d0f8; font-family: helvetica;padding:10px;font-weight: 600;"><div align="center"><?php echo $data['name'].' ('.$data['email_user'] .')'; ?> have been successfully registered</div></td>
                            </tr>                            
                            <tr>
                                <td style="background:#2c3242; color:#53d0f8; font-family: helvetica;padding:10px;font-weight: 600;">Stage Name:</td>
                            ...
                            <tr>
                                <td style="background:#2c3242; color:#53d0f8; font-family: helvetica;padding:10px;font-weight: 600;">Address:</td>
                            ...
                            <tr>
                                <td style="background:#2c3242; color:#53d0f8; font-family: helvetica;padding:10px;font-weight: 600;">Is Playlist Contributor:</td>
                            ...
                            <tr>
                                <td style="background:#2c3242; color:#53d0f8; font-family: helvetica;padding:10px;font-weight: 600;">Dj Radio Station:</td>
                                <td style="background:#2c3242; color:#C7C7C7; font-family: helvetica;padding:10px;font-weight: 400;"><?php echo isset($data['djRadioStation']) ? urldecode($data['djRadioStation']) : ''; ?></td>
                            </tr>
                            <tr>
                                <td style="background:#2c3242; color:#53d0f8; font-family: helvetica;padding:10px;font-weight: 600;">Social Media:</td>
                                <td style="background:#2c3242; color:#C7C7C7; font-family: helvetica;padding:10px;font-weight: 400;"><?php echo isset($data['fb']) ? '<p> Facebook: '.urldecode($data['fb']).'</p>' : ''; echo isset($data['fb']) ? '<p> Twitter: '.urldecode($data['twt']).'</p>' : '';echo isset($data['insta']) ? '<p> Instagram: '.urldecode($data['insta']).'</p>' : '';echo isset($data['linkedin']) ? '<p> Linkedin: '.urldecode($data['linkedin']).'</p>' : ''; ?></td>
                            </tr>                                                                                                               
                        </table>
                        <table style="width: 99%;border-collapse: collapse; ">
                            <tr>
                                <td colspan="2" style="background:#0B1023;text-align:center; font-weight: 600; padding: 30px 10px 30px 10px;">
                                    <a href="<?php echo isset($data['appUrl']) ? urldecode($data['appUrl']).'/admin/member_view?mid='.$data['djMemId'] : '#'; ?>" style="background:#5BC5F1; color: white;padding:12px 20px;text-decoration: none;font-family: helvetica; " target="_blank">View <?= $data['name']; ?> Profile</a>
                                </td>                               
                            </tr>
                        </table>
