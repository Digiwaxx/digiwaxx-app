                             ...
                             <?php //pArr($track);?>
                                 <div>
									 ...
									 <div class="col-sm-6 form-group">
                                         <label class="col-sm-3 control-label no-padding-right" for="artist">Artist </label>
                                         <div class="col-sm-9">
                                             <input type="text" id="artist" name="artist" class="col-xs-10 col-sm-10" value="<?php echo urldecode($track->artist); ?>" />
                                         </div>
                                     </div>
                                     <div class="col-sm-6 form-group">
                                         <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                                             Title </label>
                                         <div class="col-sm-9">
                                             <input type="text" id="title" name="title" class="col-xs-10 col-sm-10" value="<?php echo urldecode($track->title); ?>" />
                                         </div>
                                     </div>
									 <div class="col-sm-6 form-group">
                                         <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                                     ...
                                     <div style="clear:both;"></div>
                                     <div class="col-sm-6 form-group">
                                         <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Time
                                         </label>
                                         <div class="col-sm-9">
                                             <input type="text" id="time" name="time" class="col-xs-10 col-sm-10" value="<?php echo urldecode($track->time); ?>" />
                                         </div>
                                     </div>
                                     ...
                                     <div class="col-sm-6 form-group">
                                         <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                                             Genre </label>
                                         <div class="col-sm-9">
                                             <select name="genre" id="genre" class="col-xs-10 col-sm-10" onchange="change_genre(this.value)">
                              ...
                              <!--       <div class="col-sm-6 form-group">
                                     ...
                                     <div class="col-sm-6 form-group">
                                         <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Page Image (Artwork) </label>
                                         <div class="col-sm-9">
                                         ...
                                         <?php  }
                                               else if (strlen($track->imgpage) > 4 && file_exists(base_path('ImagesUp/'.$track->imgpage)) && @is_array(getimagesize(base_path('ImagesUp/'.$track->imgpage)))) { ?>
                                     ...
                                     <div class="col-sm-6 form-group">
                                         ...
                                         <?php  }
                                               else if (strlen($track->coverimage) > 4 && file_exists(base_path('ImagesUp/'.$track->coverimage)) && @is_array(getimagesize(base_path('ImagesUp/'.$track->coverimage)))) { ?>
                                    ...
                                    <div class="col-sm-6 form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="contact_email" name="contact_email" class="col-xs-8 col-sm-8" value="<?php echo urldecode($track->contact_email); ?> <?php if(empty($track->contact_email)) {  } ?>">
                                    ...
                                    <div class="col-sm-6 form-group">
                                     ...
                                     <!--?php if(sizeof($logoIds)>1){ ?>
                                         <div class="col-lg-12 col-md-offset-5">
                                             <a target="_blank" href="<!--?php //echo url("admin/track_logo_order?tid=" . $track->id); ?>">Change Logos Order</a>
                                         </div-->
                                     <!--?php } ?-->
                                     ...
                                     <div class="col-sm-6 form-group">
                                         <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Video
                                             Link </label>
                                         <div class="col-sm-9">
                                             <input type="text" id="link1" name="video" class="col-xs-10 col-sm-10" value="<?php echo $track->videoURL; ?>" />
                                         </div>
                                     </div>
                                     <div class="col-sm-6 form-group">
                                         <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                                     ...
                                     <div class="col-sm-6 form-group">
                                         ...
                                         <div class="col-sm-9">
                                             <input type="text" id="twitterLink" name="twitterLink" class="col-xs-10 col-sm-10" value="<?php if(isset($track->twitterLink)){ echo $track->twitterLink; } ?>" />
                                         </div>
                                     </div>
                                     <div style="clear:both;"></div>
                                     <div class="col-sm-6 form-group">
                                         ...
                                         <div class="col-sm-9">
                                             <input type="text" id="instagramLink" name="instagramLink" class="col-xs-10 col-sm-10" value="<?php if(isset($track->instagramLink)){ echo $track->instagramLink; } ?>" />
                                         </div>
                                     </div>
                                     <div class="col-sm-6 form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Tik Tok </label>
                                        <div class="col-sm-9">
                                            <input type="text" id="tiktokLink" name="tiktokLink" class="col-xs-10 col-sm-10" value="<?php if(isset($track->tiktokLink)){ echo $track->tiktokLink; } ?>" >
                                        </div>
                                    </div>
                                    <div style="clear:both;"></div>
                                    <div class="col-sm-6 form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="snapchatLink" name="snapchatLink" class="col-xs-10 col-sm-10" value="<?php if(isset($track->snapchatLink)){ echo $track->snapchatLink; } ?>" >
                                        </div>
                                    </div>
                                    <div class="col-sm-6 form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Others </label>
                                        <div class="col-sm-9">
                                            <input type="text" id="othersLink" name="othersLink" class="col-xs-10 col-sm-10" value="<?php if(isset($track->othersLink)){ echo $track->othersLink; } ?>" >
                                        </div>
                                    </div>
                                     <div style="clear:both;"></div>
                                    <!-- <div class="space-24"></div>
