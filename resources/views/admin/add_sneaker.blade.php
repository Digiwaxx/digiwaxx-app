...
<div class="main-content">
	<div class="main-content-inner">
		...
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<ul class="breadcrumb">
				<li class="active"><i class="ace-icon fa fa-list list-icon"></i> ADD SNEAKER</li>
			</ul>
		</div>
		<!-- /section:basics/content.breadcrumbs -->
		<div class="page-content">
			<div class="row">
				<div class="col-xs-12">
					<div class="news-form">
						<?php $route = route('addsneaker'); ?>
						<form method="post" action="<?php echo $route;?>" enctype=multipart/form-data id="add_sneaker">
							@csrf
							<div class="form-group">
								<label for="news_title">Name</label>
								<input type="text" class="form-control" id="news_title" name="sneaker_title" aria-describedby="emailHelp" placeholder="Enter Title"required>
							...
							<div class="form-group form-check">
								...
								<input type="number" class="form-check-input" id="sneaker_price" name="sneaker_price">
