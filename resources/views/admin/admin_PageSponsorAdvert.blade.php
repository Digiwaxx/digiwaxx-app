	...
	<div class="breadcrumbs" id="breadcrumbs">
	   ...
	   <!-- /.breadcrumb -->
	   <div class="view">
	    <a href="<?php echo url(route('SponsorAdvertise')) ?>" target="_blank" title="Preview Page" class="btn btn-sm btn-primary">VIEW</a>
	</div>
	</div>
    <!-- /section:basics/content.breadcrumbs -->
			  ...
			  <div class="row">
				 <div class="col-xs-12">
					...
					<form action="" method="post">
					   ...
					   <textarea class="ckeditor" name="bannerText"><?php if(!empty($bannerText[0]->bannerText)){ echo stripslashes(urldecode($bannerText[0]->bannerText)); } ?></textarea>
					   <br />
