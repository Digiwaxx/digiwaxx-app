	...
	<div class="breadcrumbs" id="breadcrumbs">
	   ...
	   <!-- /.breadcrumb -->
	   <div class="view">
	    <a href="<?php echo url(route('PromoteYourProject')) ?>" target="_blank" title="Preview Page" class="btn btn-sm btn-primary">VIEW</a>
	</div>
	</div>
    <!-- /section:basics/content.breadcrumbs -->
    <div class="page-content">
		<div class="page-header">
		   <h1>
			  ...
			  Promote your project page content
			  </small>
		   </h1>
		</div>
		...
		<div class="page-header">
		   <h1>
			  <small>
			  <i class="ace-icon fa fa-angle-double-right"></i>
			 1Promote your project page banner
			  </small>
		   </h1>
		</div>
		<div class="row">
		...
		<div class="page-header">
		   <h1>
			  <small>
			  <i class="ace-icon fa fa-angle-double-right"></i>
			 1Promote your project page content
			  </small>
		   </h1>
		</div>
		<!-- /.page-header -->
		   ...
		   <div class="col-xs-12">
			  ...
			  <div class="row">
				 <div class="col-xs-12">
					<form action="" method="post">
						@csrf
					   <textarea class="ckeditor" name="promote1"><?php echo stripslashes(urldecode($promote1[0]->bannerText)); ?></textarea>
					   <br />
					   <input type="submit"  name="updatePromote1" value="Submit" class="btn btn-sm btn-primary"  />
					</form>
				 </div>
				 <!-- /.span -->
			  </div>
		...
		<div class="page-header">
		   <h1>
			  <small>
			  <i class="ace-icon fa fa-angle-double-right"></i>
			 2Promote your project page content
			  </small>
		   </h1>
		</div>
		<!-- /.page-header -->
		   ...
		   <div class="col-xs-12">
			  ...
			  <div class="row">
				 <div class="col-xs-12">
					<form action="" method="post">
						@csrf
					   <textarea class="ckeditor" name="promote2"><?php echo stripslashes(urldecode($promote2[0]->bannerText)); ?></textarea>
					   <br />
					   <input type="submit"  name="updatePromote2" value="Submit" class="btn btn-sm btn-primary"  />
					</form>
				 </div>
				 <!-- /.span -->
			  </div>
		...
		<div class="page-header">
		   <h1>
			  <small>
			  <i class="ace-icon fa fa-angle-double-right"></i>
			 3Promote your project page content
			  </small>
		   </h1>
		</div>
		<!-- /.page-header -->
		   ...
		   <div class="col-xs-12">
			  ...
			  <div class="row">
				 <div class="col-xs-12">
					<form action="" method="post">
						@csrf
					   <textarea class="ckeditor" name="promote3"><?php echo stripslashes(urldecode($promote3[0]->bannerText)); ?></textarea>
					   <br />
					   <input type="submit"  name="updatePromote3" value="Submit" class="btn btn-sm btn-primary"  />
					</form>
				 </div>
				 <!-- /.span -->
			  </div>
