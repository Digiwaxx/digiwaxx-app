								...
								<div class="row">
									...
									<div class="profile-user-info profile-user-info-striped">
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">-->
														 	<?php  // echo urldecode($member->email); ?>
													<!--</div>
												</div>-->
	...
	<?php if(isset($members['data'][0]->player) && strcmp(urldecode($members['data'][0]->player),'Quicktime')==0) { echo 'Quicktime'; } ?>
										...
										<div class="profile-user-info profile-user-info-striped">
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
													  ...
													  if($member->commercialdj_satday==1) { $commercialDays[] = 'Satday'; }
										...
										<div class="profile-user-info profile-user-info-striped">
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
													  ...
													  if($member->noncommercialdj_satday==1) { $noncommercialDays[] = 'Satday'; }
										...
										<div class="profile-user-info profile-user-info-striped">
												...
												<div class="profile-info-row">
													...
													<?php $satelliteDays = array();
													  ...
													  if($member->satellitedj_satday==1) { $satelliteDays[] = 'Satday'; }
										...
										<div class="profile-user-info profile-user-info-striped">
												...
												<div class="profile-info-row">
													...
													<?php $internetDays = array();
													  ...
													  if($member->internetdj_satday==1) { $internetDays[] = 'Satday'; }
										...
										<div class="profile-user-info profile-user-info-striped">
												...
												<div class="profile-info-row">
													...
													<?php $pirateDays = array();
													  ...
													  if($member->piratedj_satday==1) { $pirateDays[] = 'Satday'; }
							...
							<?php if(isset($radio['data'][0]->radiotype_tech) && $radio['data'][0]->radiotype_tech==1) { echo 'I.T./Tech'; echo '<br />'; } ?> 
												...
												<div class="profile-info-row">
										            ...
										            <?php if(!empty($radio['data'])) echo $radio['data'][0]->stationcallletters; ?>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
													<?php if(!empty($radio['data'])) echo $radio['data'][0]->stationname; ?>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
													<?php if(!empty($radio['data'])) echo $radio['data'][0]->stationfrequency; ?>
													</div>
												</div>
        ...
        if($radio['data'][0]->radiotype_musicdirector==1 || $radio['data'][0]->radiotype_programdirector==1 || $radio['data'][0]->radiotype_jock==1) {	?>		
												<div class="profile-info-row">
													<div class="profile-info-name"></div>
            ...
            <?php if(isset($radio['data'][0]->radiotype_musicdirector) && $radio['data'][0]->radiotype_musicdirector==1) { ?>													    
							...
							<?php if(isset($media['data'][0]->media_name)) {  echo $media['data'][0]->media_name;  } 
													  ...
													  if($radio->musicdirector_monday==1) { $musicalDays[] = 'Monday'; }
													  if($radio->musicdirector_tuesday==1) { $musicalDays[] = 'Tuesday'; }
													  if($radio->musicdirector_wednesday==1) { $musicalDays[] = 'Wednesday'; }
													  if($radio->musicdirector_thursday==1) { $musicalDays[] = 'Thursday'; }
													  if($radio->musicdirector_friday==1) { $musicalDays[] = 'Friday'; }
													  if($radio->musicdirector_satday==1) { $musicalDays[] = 'Satday'; }
													  if($radio->musicdirector_sunday==1) { $musicalDays[] = 'Sunday'; }
													  if($radio->musicdirector_varies==1) { $musicalDays[] = 'Varies'; }
		...
		<?php } if(isset($radio['data'][0]->radiotype_programdirector) && $radio['data'][0]->radiotype_programdirector==1) { ?>			
							...
							<?php echo $radio['data'][0]->programirector_showname;  ?>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
							                         <?php  $programDays = array();
													  if($radio->programdirector_monday==1) { $programDays[] = 'Monday'; }
													  if($radio->programdirector_tuesday==1) { $programDays[] = 'Tuesday'; }
													  if($radio->programdirector_wednesday==1) { $programDays[] = 'Wednesday'; }
													  if($radio->programdirector_thursday==1) { $programDays[] = 'Thursday'; }
													  if($radio->programdirector_friday==1) { $programDays[] = 'Friday'; }
													  if($radio->programdirector_satday==1) { $programDays[] = 'Satday'; }
													  if($radio->programdirector_sunday==1) { $programDays[] = 'Sunday'; }
													  if($radio->programdirector_varies==1) { $programDays[] = 'Varies'; }
			...
			<?php } if(isset($radio['data'][0]->radiotype_jock) && $radio['data'][0]->radiotype_jock==1) { ?>			
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
							                         <?php  $personalityDays = array();
													  if($radio->onairpersonality_monday==1) { $personalityDays[] = 'Monday'; }
													  if($radio->onairpersonality_tuesday==1) { $personalityDays[] = 'Tuesday'; }
													  if($radio->onairpersonality_wednesday==1) { $personalityDays[] = 'Wednesday'; }
													  if($radio->onairpersonality_thursday==1) { $personalityDays[] = 'Thursday'; }
													  if($radio->onairpersonality_friday==1) { $personalityDays[] = 'Friday'; }
													  if($radio->onairpersonality_satday==1) { $personalityDays[] = 'Satday'; }
													  if($radio->onairpersonality_sunday==1) { $personalityDays[] = 'Sunday'; }
													  if($radio->onairpersonality_varies==1) { $personalityDays[] = 'Varies'; }
				...
				<?php if(isset($media['data'][0]->mediatype_newsletter) && $media['data'][0]->mediatype_newsletter==1) { echo 'Newsletter'; echo '<br />'; } ?>
							 ...
							 <?php if(isset($media['data'][0]->media_department)) { echo $media['data'][0]->media_department;  } ?>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
													<?php  if(!empty($radio['data'])) echo $media['data'][0]->media_website; ?>
													</div>
												</div>
							...
							<?php if(!empty($record['data'])) echo $record['data'][0]->label_name; ?>
				...
				<?php if(isset($record['data'][0]->labeltype_distribution) && $record['data'][0]->labeltype_distribution==1) { echo 'Distribution'; echo '<br />'; } ?>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
							<?php if(!empty($record['data'])) echo $record['data'][0]->label_department; ?>
													</div>
												</div>
							...
							<?php if(!empty($management['data'])) echo $management['data'][0]->management_name; ?>
				...
				<?php if(isset($management['data'][0]->managementtype_finance) && $management['data'][0]->managementtype_finance==1) { echo 'Finance/Accounting'; echo '<br />'; } ?>
							...
							<?php if(!empty($clothing['data'])) echo $clothing['data'][0]->clothing_name; ?>
				...
				<?php if(!empty($clothing['data'])) echo $clothing['data'][0]->clothing_department; ?>
							...
							<?php if(!empty($promoter['data'])) echo $promoter['data'][0]->promoter_name; ?>
 ...
 <?php if(isset($promoter['data'][0]->promoter_department) && strcmp($promoter['data'][0]->promoter_department,'i.t._or_tech')==0) { echo 'I.T./Tech'; } ?> 
				...
				<?php if(!empty($promoter['data'])) echo $promoter['data'][0]->promoter_website; ?>
		...
		<?php if(isset($production['data'][0]->productiontype_choreographer) && $production['data'][0]->productiontype_choreographer==1) { echo 'Choregrapher'; echo '<br />'; } ?> 
				<?php if(isset($production['data'][0]->productiontype_sound) && $production['data'][0]->productiontype_sound==1) { echo 'Sound Engineer'; echo '<br />'; } ?> 
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
				<?php if(!empty($production['data'])) echo $production['data'][0]->production_name; ?>
