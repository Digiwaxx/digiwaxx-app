...
<div class="main-content">
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<a href="javascript:void()" onclick="acceptMember('<?php echo $_GET['mid']; ?>')" class="btn btn-success btn-sm">Verify</a>

	<!--	<a href="javascript:void()" onclick="declineMember('<?php // echo $_GET['mid']; ?>')" class="btn btn-warning btn-sm">Decline</a>

						<a href="javascript:void()" onclick="deleteMember('<?php // echo $_GET['mid']; ?>')" class="btn btn-danger btn-sm">Delete</a>
-->
									<div class="space-10"></div>
	...
	<?php if(isset($members['data'][0]->player) && strcmp(urldecode($members['data'][0]->player),'Quicktime')==0) { echo 'Quicktime'; } ?>
							...
							<?php if(isset($radio['data'][0]->radiotype_tech) && $radio['data'][0]->radiotype_tech==1) { echo 'I.T./Tech'; echo '<br />'; } ?> 
												...
												<div class="profile-info-row">
										            ...
										            <?php if(!empty($radio['data'][0]->stationcallletters)) echo $radio['data'][0]->stationcallletters; ?>
												...
												<div class="profile-info-row">
													...
													<?php if(!empty($radio['data'][0]->stationname)) echo $radio['data'][0]->stationname; ?>
												...
												<div class="profile-info-row">
													...
													<?php if(!empty($radio['data'][0]->stationfrequency)) echo $radio['data'][0]->stationfrequency; ?>
		...
		<?php } if(isset($radio['data'][0]->radiotype_programdirector) && $radio['data'][0]->radiotype_programdirector==1) { ?>			
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
							                         ...
							                         <?php  $programDays = array();
													  ...
													  if($radio['data'][0]->programdirector_saturday==1) { $programDays[] = 'Saturday'; }
			...
			<?php } if(isset($radio['data'][0]->radiotype_jock) && $radio['data'][0]->radiotype_jock==1) { ?>			
				...
				<?php if(isset($media['data'][0]->mediatype_newsletter) && $media['data'][0]->mediatype_newsletter==1) { echo 'Newsletter'; echo '<br />'; } ?>
							 ...
							 <?php if(isset($media['data'][0]->media_department)) { echo $media['data'][0]->media_department;  } ?>
												...
												<div class="profile-info-row">
													...
													<?php if(!empty($media['data'][0]->media_website)) echo $media['data'][0]->media_website; ?>
							...
							<?php if(!empty($record['data'][0]->label_name)) echo $record['data'][0]->label_name; ?>
				...
				<?php if(isset($record['data'][0]->labeltype_distribution) && $record['data'][0]->labeltype_distribution==1) { echo 'Distribution'; echo '<br />'; } ?>
							...
							<?php if(!empty($record['data'][0]->label_department)) echo $record['data'][0]->label_department; ?>
							...
							<?php if(!empty($management['data'][0]->management_name)) echo $management['data'][0]->management_name; ?>
				...
				<?php if(isset($management['data'][0]->managementtype_finance) && $management['data'][0]->managementtype_finance==1) { echo 'Finance/Accounting'; echo '<br />'; } ?>
							...
							<?php if(!empty($clothing['data'][0]->clothing_name)) echo $clothing['data'][0]->clothing_name; ?>
				...
				<?php if(!empty($clothing['data'][0]->clothing_department)) echo $clothing['data'][0]->clothing_department; ?>
							...
							<?php if(!empty($promoter['data'][0]->promoter_name)) echo $promoter['data'][0]->promoter_name; ?>
 ...
 <?php if(isset($promoter['data'][0]->promoter_department) && strcmp($promoter['data'][0]->promoter_department,'i.t._or_tech')==0) { echo 'I.T./Tech'; } ?> 
				...
				<?php if(!empty($promoter['data'][0]->promoter_website)) echo $promoter['data'][0]->promoter_website; ?>
			...
			<?php if(isset($special['data'][0]->servicestype_graphicdesign) && $special['data'][0]->servicestype_graphicdesign==1) { echo 'Graphic Design';  echo '<br />'; } ?> 
				...
				<?php if(!empty($special['data'][0]->services_name)) echo $special['data'][0]->services_name; ?>
				...
				<?php if(!empty($special['data'][0]->services_website)) echo $special['data'][0]->services_website; ?>
		...
		<?php if(isset($production['data'][0]->productiontype_choreographer) && $production['data'][0]->productiontype_choreographer==1) { echo 'Choregrapher'; echo '<br />'; } ?> 
				...
				<?php if(!empty($production['data'][0]->production_name)) echo $production['data'][0]->production_name; ?>
...

					{
					 ...
					 document.getElementById('audioFiles').appendChild(parentDiv);
					  ...
					  function acceptMember(mid)

					  {

					     if(confirm("Confirm Verify Member"))

						 {

						   window.location = 'manage_pending_member?mid='+mid+"&acceptId="+mid;
			  ...
			  function declineMember(mid)

					  {
...

						 {
						   ...
						   window.location = 'manage_pending_member?mid='+mid+"&declineId="+mid;
			  ...
			  function deleteMember(mid)

					  {
...

						 {
						   ...
						   window.location = 'manage_pending_member?mid='+mid+"&deleteId="+mid;
