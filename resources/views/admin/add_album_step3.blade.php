        ...
        <div class="main-content-inner">
            ...
            <div class="breadcrumbs" id="breadcrumbs">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Add Album - Step 3 &nbsp;&nbsp;</li>
                </ul><!-- /.breadcrumb -->
                {{-- <form method="POST" style="display: inline-block;" action="<?php echo url('Member_track_download?tid=' .$album_id ); ?>" target="_blank">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        ...
                        <form id="add_trackform" role="form" action="" name="addtrackform" method="post"
                            enctype="multipart/form-data" onsubmit="return validate()" autocomplete="off" style="color:white;">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" id="artist" name="artist"
                                            class="form-control artist_title" value="{{ isset($track_data->artist) && !empty($track_data->artist) ?  urldecode($track_data->artist) : '' }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input placeholder="00:00" required type="text" id="time" name="time"
                                                value="{{ isset($track_data->time) && !empty($track_data->time) ?  urldecode($track_data->time) : '' }}" class="form-control" pattern="[0-9]{2}:[0-9]{2}">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select required name="albumType" id="albumType" class="form-control">
                                            ...
                                            <option value="1"   {{ isset($track_data->albumType) && !empty($track_data->albumType) && ($track_data->albumType=='1') ? 'selected' : '' }}>Single</option>
                                            <option value="2"   {{ isset($track_data->albumType) && !empty($track_data->albumType) && ($track_data->albumType=='2') ? 'selected' : '' }}>Album</option>
                                            <option value="3"   {{ isset($track_data->albumType) && !empty($track_data->albumType) && ($track_data->albumType=='3') ? 'selected' : '' }}>EP</option>
                                            <option value="4"   {{ isset($track_data->albumType) && !empty($track_data->albumType) && ($track_data->albumType=='4') ? 'selected' : '' }}>Mixtape</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input disabled type="text" id="album" name="album" class="form-control"
                                        ...
                                        <div class="radio">
                                            <label>
                                                <input required name="availableMembers" type="radio" class="ace"
                                                    value="1"{{ isset($track_data->member) && !empty($track_data->member) && ($track_data->member=='1') ? 'checked' : '' }}
                                                    >
                                                <span class="lbl"> Yes</span>
                                            </label>
                                            <label>
                                                <input checked required name="availableMembers" type="radio" class="ace"
                                                    value="0"{{ isset($track_data->member) && !empty($track_data->member) && ($track_data->member!='1') ? 'checked' : '' }}
                                                    >
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="radio">
                                            ...
                                            <label>
                                                <input checked required name="reviewable" type="radio" class="ace"
                                                    value="0"{{ isset($track_data->review) && !empty($track_data->review) && ($track_data->review!='0') ? 'checked' : '' }}
                                                    >
                                                <span class="lbl"> No</span>
                                            </label>
                                        </div>
                                    ...
                                    <div class="col-sm-12 form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <div class="col-auto">
                                                ...
                                                <div id="">
                                                    <img src="https://digiwaxx.com/digiwaxx-dev/admin/audio_stream_pcloud/{{$logo}}" width="50" height="56" />
                                                </div>
                                                @endforeach
                                            </div>
                                            @endif --}}
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-12 form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Company
                                        </label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="col-sm-12 form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Link
                                        </label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="col-sm-12 form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Logo
                                        </label>
                                        <div class="col-sm-9">
                                ...
                                <div class="col-sm-6 form-group">
                                    ...
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Website 1
                                    </label>
                                ...
                                <div class="col-sm-6 form-group">
                                    ...
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Website 2
                                    </label>
                                ...
                                <div class="col-sm-6 form-group">
                                    ...
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Facebook
                                    </label>
                                ...
                                <div class="col-sm-6 form-group">
                                    ...
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Twitter
                                    </label>
                                ...
                                <div class="col-sm-6 form-group">
                                    ...
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Instagram
                                    </label>
                                ...
                                <div class="col-sm-6 form-group">
                                    ...
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Tik Tok
                                    </label>
                                ...
                                <div class="col-sm-6 form-group">
                                    ...
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Snapchat
                                    </label>
                                ...
                                <div class="col-sm-6 form-group">
                                    ...
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Others
                                    </label>
                                ...
                                <div class="col-sm-6 form-group">
                                    ...
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Youtube
                                    </label>
            ...
            <script>
                ...
                window.lsData['album_id'] = "{{ $album_id }}";
                window.lsData['urlSaveTrack'] = "{{ route('admin.save.add.album.step3', ['id' => $album_id]) }}";
                window.lsData['album_listing'] = "{{ route('admin_albums_listing') }}";
            ...
            <script src="{{ asset('public/js/add_album_step3.js') }}"></script>
