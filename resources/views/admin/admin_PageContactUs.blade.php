	...
	<div class="breadcrumbs" id="breadcrumbs">
	   ...
	   <!-- /.breadcrumb -->
	   <div class="view">
	    <a href="<?php echo url(route('Contactus')) ?>" target="_blank" title="Preview Page" class="btn btn-sm btn-primary">VIEW</a>
	</div>
	</div>
		   ...
		   <div class="col-xs-12">
			  ...
			  <div class="row">
				 <div class="col-xs-12">
					<form action="" method="post">
						@csrf
					   <textarea class="ckeditor" name="getintouch"><?php echo stripslashes(urldecode($getInTouchText[0]->meta_value)); ?></textarea>
					   <br />
					   <input type="submit"  name="addGetInTouchText" value="Submit" class="btn btn-sm btn-primary"  />
					</form>
				 </div>
				 <!-- /.span -->
			  </div>
