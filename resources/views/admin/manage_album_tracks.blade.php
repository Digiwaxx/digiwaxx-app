<x-slot name="page_title">{{ __('Add Album Track Audio Files') }}</x-slot>
    ...
    <div class="main-content add-track-page">
        <div class="main-content-inner">
                                        ...
                                        <tr class="template-download">
                                            ...
                                            <td class="left">
                                                <input class="form-control" type="text"
                                                    ...
                                                    name="otherversion[{{ $mp3->id }}]" placeholder="Other Version">
                                            </td>
                                            <td>
                                                <p class="name">
            ...
            <script>
                ...
                window.lsData['urlSaveMp3'] = "{{ route('save.mp3.album.track') }}";
                window.lsData['step3'] = "{{ route('manage_track_meta_info', ['id' =>  isset($track_id) && !empty($track_id) ? Crypt::encryptString($track_id) : '']) }}";
                window.lsData['step2'] = "{{ route('manage_album_audios', ['id' =>  isset($album_id) && !empty($album_id) ? Crypt::encryptString($album_id) : '']) }}";
            ...
            <script src="{{ asset('public/js/manage_album_tracks.js') }}"></script>
