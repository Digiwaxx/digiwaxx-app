...
<section class="below-banner">
    ...
    <!-- <h1 class="news_title"><?php //echo $display_news[0]->Title; ?></h1> -->
            <div class="display_news_section">
                        ...
                        <div class="row">
                            <?php foreach($display_news as $value){?> 
                                  
                                    <div class="col-md-4">
                                       <div class="display_news m-5">                    
                                            <?php  if(!empty($value->pCloudFileID)){
                                            ...
                                            ?>
                                           <a href="{{route("display-news",['id'=>$value->id])}}">  <img src="<?php echo $news_artwork ?>" alt="cat-img" class="img-fluid news_img"></a>
                                             <a href="{{route("display-news",['id'=>$value->id])}}">  <h5 class="news_title_below"><?php 
