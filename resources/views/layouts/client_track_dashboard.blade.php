...
<head>
    ...
    <!--world map-->
    {{-- <link rel="stylesheet" href="{{ asset('public/jvectormap/jquery-jvectormap-2.0.3.css') }}" type="text/css" media="screen" /> changed --}}
    <!--audio css-->
                            ...
                            <div class="row" id="client-onetime">
                                <div class="col-lg-3 col-md-6 col-sm-6 pb-2">
                                    <div class="dso-item">
                                        ...
                                        <div class="sub-btn">
                                            @if(session()->get('clientPackage') >= 1 && session()->get('clientPackage')
                                            <= 4 ) <input type="submit" class="btn btn-gradient btn-theme" name="basic" value="BUY" disabled="disabled" style="background:#ebebeb !important;color: #7b7b7b;" />
                                            @else
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 pb-2">
                                    <div class="dso-item">
                                        ...
                                        <div class="sub-btn">
                                            @if(session()->get('clientPackage') >= 2 && session()->get('clientPackage')
                                            <= 4) <input type="submit" class="btn btn-gradient btn-theme" name="regular" value="BUY" disabled="disabled" style="background:#ebebeb !important;color: #7b7b7b;" />
                                            @else
                                            <form action="{{ url('Client_payment1') }}" method="post">
                                                @csrf
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 pb-2">
                                    <div class="dso-item">
                                        ...
                                        <div class="sub-btn">
                                            @if(session()->get('clientPackage') >= 3 && session()->get('clientPackage')
                                            <= 4) <input type="submit" class="btn btn-gradient btn-theme" name="standard" value="BUY" disabled="disabled" style="background:#ebebeb !important;color: #7b7b7b;" />
                                            @else
                                            <form action="{{ url('Client_payment1') }}" method="post">
                                                @csrf
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 pb-2">
                                    <div class="dso-item">
                                        ...
                                        <div class="sub-btn">
                                            @if(session()->get('clientPackage') >= 4 && session()->get('clientPackage')
                                            <= 4) <input type="submit" class="btn btn-gradient btn-theme" name="advance" value="BUY" disabled="disabled" style="background:#ebebeb !important;color: #7b7b7b;" />
                                            @else
                                            <form action="{{ url('Client_payment1') }}" method="post">
                                                @csrf
