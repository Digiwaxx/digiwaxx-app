                    ...
                    <div class="tabs-section">
                        ...
                        <div class="msg-blk f-block">                            
                            <div class="msg nav nav-tabs">
                                <a href="<?php echo url("Client_messages"); ?>" class="ats nav-link active">ALL MESSAGES (<?php echo $messages['numRows']; ?>)</a>
                                        ...
                                        <div class="msg-item unread">
                                            <div class="row">
                                                <div class="col-lg-2 col-md-1 col-sm-1 col-xs-3">
                                                    <div class="avatar">
                                                        <?php //echo base_path('member_images/' . $senderDetails[$message->messageId]['id'] . '/' . $senderDetails[$message->messageId]['image']);?>
                                                        <?php 
                                                        ...
                                                        elseif (!empty($senderDetails[$message->messageId]['image'])&&isset($senderDetails[$message->messageId]['image']) && file_exists(base_path('member_images/' . $senderDetails[$message->messageId]['id'] . '/' . $senderDetails[$message->messageId]['image']))) {
                                                ...
                                                <div class="col-lg-7 col-md-8 col-sm-8 col-xs-12">
                                                    <div class="msg-txt">
                                                        <a href="<?php echo url("Client_messages_conversation?mid=" . $senderDetails[$message->messageId]['id']); ?>">
                                                            <?php echo substr($message->message, 0, 40); ?></a>
                                                    </div>
                                                </div>
                                            </div><!-- eof row -->
                                        </div><!-- eof msg-item -->
