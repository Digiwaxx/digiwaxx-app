...
.form-group { margin-bottom:30px; } 
 ...
 <section class="main-dash">
                ...
                <div class="container">
                                 <div class="row">
                                     ...
                                     <div class="profile-user-info profile-user-info-striped">
                                                ...
                                                <div class="profile-info-row">
                                                     ...
                                                     <div class="profile-info-value">
                                                              <?php echo urldecode($member->phone); ?>
                                                 </div>
                                                 </div>
                                                 <div class="profile-info-row">
                                                 ...
                                                 <div class="profile-info-row">
                                                     <div class="profile-info-name"> Gemder </div>
                         ...
                         ?>	
                                        ...
                                        <div class="table-header">
                                         ...
                                         <?php //echo '<pre>';print_r($socialInfo);die; ?>
                                         <div class="profile-user-info profile-user-info-striped">
                                                <div class="profile-info-row">
                                                     <div class="profile-info-name"> Facebook </div>
 
                                                     <div class="profile-info-value"> {{ $socialInfo['data'][0]->facebook ?? ''}} </div> 
                                                </div> 
                                                <div class="profile-info-row">
                                                     <div class="profile-info-name"> Twitter </div>
 
                                                     <div class="profile-info-value"> {{ $socialInfo['data'][0]->twitter ?? ''}} </div> 
                                                </div> 
                                                <div class="profile-info-row">
                                                     <div class="profile-info-name"> Instagram </div>
 
                                                     <div class="profile-info-value"> {{ $socialInfo['data'][0]->instagram ?? ''}} </div> 
                                                </div>
                                                <div class="profile-info-row">
                                                     <div class="profile-info-name"> Snapchat </div>
 
                                                     <div class="profile-info-value"> {{ $socialInfo['data'][0]->snapchat ?? ''}} </div> 
                                                </div>                                                 
                                                <div class="profile-info-row">
                                                     <div class="profile-info-name"> Linkedin </div>
 
                                                     <div class="profile-info-value">{{ $socialInfo['data'][0]->linkedin ?? ''}} </div> 
                                                </div>
                                                 <div class="profile-info-row">
                                                     <div class="profile-info-name"> Tiktok </div>
 
                                                     <div class="profile-info-value">{{ $socialInfo['data'][0]->tiktok ?? ''}} </div> 
                                                </div>
                                                <div class="profile-info-row">
                                                     <div class="profile-info-name"> Triller </div>
 
                                                     <div class="profile-info-value">{{ $socialInfo['data'][0]->triller ?? ''}} </div> 
                                                </div>
                                                 <div class="profile-info-row">
                                                     <div class="profile-info-name"> Twitch </div>
 
                                                     <div class="profile-info-value">{{ $socialInfo['data'][0]->twitch ?? ''}} </div> 
                                                </div>
                                                <div class="profile-info-row">
                                                     <div class="profile-info-name"> Mixcloud </div>
 
                                                     <div class="profile-info-value">{{ $socialInfo['data'][0]->mixcloud ?? ''}} </div> 
                                                </div>                                                                                                                                                                                      
                                          </div>                                                
                                         <div class="table-header">
                                              MY PREFERENCES
     ...
     <?php if(isset($members['data'][0]->player) && strcmp(urldecode($members['data'][0]->player),'Quicktime')==0) { echo 'Quicktime'; } ?>
                                         ...
                                         <div class="profile-user-info profile-user-info-striped">
                                                 ...
                                                 <div class="profile-info-row">
                                                     ...
                                                     <div class="profile-info-value">
                                                       ...
                                                       if(isset($member->commercialdj_monday) && $member->commercialdj_monday==1) { $commercialDays[] = 'Monday'; }
                                                       if(isset($member->commercialdj_tuesday) && $member->commercialdj_tuesday==1) { $commercialDays[] = 'Tuesday'; }
                                                       if(isset($member->commercialdj_wednesday) && $member->commercialdj_wednesday==1) { $commercialDays[] = 'Wednesday'; }
                                                       if(isset($member->commercialdj_thursday) && $member->commercialdj_thursday==1) { $commercialDays[] = 'Thursday'; }
                                                       if(isset($member->commercialdj_friday) && $member->commercialdj_friday==1) { $commercialDays[] = 'Friday'; }
                                                       if(isset($member->commercialdj_satday) && $member->commercialdj_satday==1) { $commercialDays[] = 'Satday'; }
                                                       if(isset($member->commercialdj_sunday) && $member->commercialdj_sunday==1) { $commercialDays[] = 'Sunday'; }
                                                       if(isset($member->commercialdj_varies) && $member->commercialdj_varies==1) { $commercialDays[] = 'Varies'; }
                                                       ...
                                                       {
                                                         $commercial_days = $commercialDays[0];
                                                       }
                                         ...
                                         <div class="profile-user-info profile-user-info-striped">
                                                 ...
                                                 <div class="profile-info-row">
                                                     ...
                                                     <div class="profile-info-value">
                                                       ...
                                                       if(isset($member->noncommercialdj_monday) && $member->noncommercialdj_monday==1) { $noncommercialDays[] = 'Monday'; }
                                                       if(isset($member->noncommercialdj_tuesday) && $member->noncommercialdj_tuesday==1) { $noncommercialDays[] = 'Tuesday'; }
                                                       if(isset($member->noncommercialdj_wednesday) && $member->noncommercialdj_wednesday==1) { $noncommercialDays[] = 'Wednesday'; }
                                                       if(isset($member->noncommercialdj_thursday) && $member->noncommercialdj_thursday==1) { $noncommercialDays[] = 'Thursday'; }
                                                       if(isset($member->noncommercialdj_friday) && $member->noncommercialdj_friday==1) { $noncommercialDays[] = 'Friday'; }
                                                       if(isset($member->noncommercialdj_satday) && $member->noncommercialdj_satday==1) { $noncommercialDays[] = 'Satday'; }
                                                       if(isset($member->noncommercialdj_sunday) && $member->noncommercialdj_sunday==1) { $noncommercialDays[] = 'Sunday'; }
                                                       if(isset($member->noncommercialdj_varies) && $member->noncommercialdj_varies==1) { $noncommercialDays[] = 'Varies'; }
                                                       ...
                                                       {
                                                         $noncommercial_days = $noncommercialDays[0];
                                                       }
                                         ...
                                         <div class="profile-user-info profile-user-info-striped">
                                                 ...
                                                 <div class="profile-info-row">
                                                     ...
                                                     <?php $satelliteDays = array();
                                                       ...
                                                       if(isset($member->satellitedj_monday) && $member->satellitedj_monday==1) { $satelliteDays[] = 'Monday'; }
                                                       if(isset($member->satellitedj_tuesday) && $member->satellitedj_tuesday==1) { $satelliteDays[] = 'Tuesday'; }
                                                       if(isset($member->satellitedj_wednesday) && $member->satellitedj_wednesday==1) { $satelliteDays[] = 'Wednesday'; }
                                                       if(isset($member->satellitedj_thursday) && $member->satellitedj_thursday==1) { $satelliteDays[] = 'Thursday'; }
                                                       if(isset($member->satellitedj_friday) && $member->satellitedj_friday==1) { $satelliteDays[] = 'Friday'; }
                                                       if(isset($member->satellitedj_satday) && $member->satellitedj_satday==1) { $satelliteDays[] = 'Satday'; }
                                                       if(isset($member->satellitedj_sunday) && $member->satellitedj_sunday==1) { $satelliteDays[] = 'Sunday'; }
                                                       if(isset($member->satellitedj_varies) && $member->satellitedj_varies==1) { $satelliteDays[] = 'Varies'; }
                                                       ...
                                                       {
                                                         $satellite_days = $satelliteDays[0];
                                                       }
                                         ...
                                         <div class="profile-user-info profile-user-info-striped">
                                                 ...
                                                 <div class="profile-info-row">
                                                     ...
                                                     <?php $internetDays = array();
                                                       ...
                                                       if(isset($member->internetdj_monday) && $member->internetdj_monday==1) { $internetDays[] = 'Monday'; }
                                                       if(isset($member->internetdj_tuesday) && $member->internetdj_tuesday==1) { $internetDays[] = 'Tuesday'; }
                                                       if(isset($member->internetdj_wednesday) && $member->internetdj_wednesday==1) { $internetDays[] = 'Wednesday'; }
                                                       if(isset($member->internetdj_thursday) && $member->internetdj_thursday==1) { $internetDays[] = 'Thursday'; }
                                                       if(isset($member->internetdj_friday) && $member->internetdj_friday==1) { $internetDays[] = 'Friday'; }
                                                       if(isset($member->internetdj_satday) && $member->internetdj_satday==1) { $internetDays[] = 'Satday'; }
                                                       if(isset($member->internetdj_sunday) && $member->internetdj_sunday==1) { $internetDays[] = 'Sunday'; }
                                                       if(isset($member->internetdj_varies) && $member->internetdj_varies==1) { $internetDays[] = 'Varies'; }
                                         ...
                                         <div class="profile-user-info profile-user-info-striped">
                                                 ...
                                                 <div class="profile-info-row">
                                                     ...
                                                     <?php $collegeDays = array();
                                                       ...
                                                       if($member->collegedj_satday==1) { $collegeDays[] = 'Satday'; }
                                                 ...
                                                 <div class="profile-info-row">
                                                     ...
                                                     <div class="profile-info-value">
                                                     <?php echo $member->collegedj_country; ?>
                                                     </div>
                                                 </div>
                                         ...
                                         <div class="profile-user-info profile-user-info-striped">
                                                 ...
                                                 <div class="profile-info-row">
                                                     ...
                                                     <?php $pirateDays = array();
                                                       ...
                                                       if(isset($member->piratedj_monday) && $member->piratedj_monday==1) { $pirateDays[] = 'Monday'; }
                                                       if(isset($member->piratedj_tuesday) && $member->piratedj_tuesday==1) { $pirateDays[] = 'Tuesday'; }
                                                       if(isset($member->piratedj_wednesday) && $member->piratedj_wednesday==1) { $pirateDays[] = 'Wednesday'; }
                                                       if(isset($member->piratedj_thursda) && $member->piratedj_thursday==1) { $pirateDays[] = 'Thursday'; }
                                                       if(isset($member->piratedj_friday) && $member->piratedj_friday==1) { $pirateDays[] = 'Friday'; }
                                                       if(isset($member->piratedj_satday) && $member->piratedj_satday==1) { $pirateDays[] = 'Satday'; }
                                                       if(isset($member->piratedj_sunday) && $member->piratedj_sunday==1) { $pirateDays[] = 'Sunday'; }
                                                       if(isset($member->piratedj_varies) && $member->piratedj_varies==1) { $pirateDays[] = 'Varies'; }
                             ...
                             <?php if(isset($radio['data'][0]->radiotype_tech) && $radio['data'][0]->radiotype_tech==1) { echo 'I.T./Tech'; echo '<br />'; } ?> 
                                                 ...
                                                 <div class="profile-info-row">
                                                     ...
                                                     <?php if(isset($radio['data'][0]->stationcallletters)){ echo $radio['data'][0]->stationcallletters; } ?>
                                                     </div>
                                                 </div>
                                                 ...
                                                 <div class="profile-info-row">
                                                     ...
                                                     <div class="profile-info-value">
                                                     <?php if(isset($radio['data'][0]->stationname)){ echo $radio['data'][0]->stationname; } ?>
                                                     </div>
                                                 </div>
                                                 ...
                                                 <div class="profile-info-row">
                                                     ...
                                                     <div class="profile-info-value">
                                                     <?php if(isset($radio['data'][0]->stationfrequency)){ echo $radio['data'][0]->stationfrequency; } ?>
                                                     </div>
                                                 </div>
                                                 
                                                 
                                                 
         <?php if(isset($radio['data'][0]->radiotype_musicdirector) || isset($radio['data'][0]->radiotype_programdirector) || isset($radio['data'][0]->radiotype_jock)) {	?>		
                                                 <div class="profile-info-row">
                                                     <div class="profile-info-name"></div>
             ...
             <?php if(isset($radio['data'][0]->radiotype_musicdirector) && $radio['data'][0]->radiotype_musicdirector==1) { ?>													    
                             ...
                             <?php if(isset($radio['data'][0]->musicdirector_musiccalltimes)){ echo $radio['data'][0]->musicdirector_musiccalltimes; }  ?>
                             ...
                             <?php if(isset($radio['data'][0]->musicdirector_host)){ echo $radio['data'][0]->musicdirector_host; }  ?>
                             ...
                             <?php if(isset($radio['data'][0]->musicdirector_showname)){ echo $radio['data'][0]->musicdirector_showname; }  ?>
                             ...
                             <?php if(isset($media['data'][0]->media_name)) {  echo $media['data'][0]->media_name;  } 
                                                       ...
                                                       if(isset($radio->musicdirector_monday) && $radio->musicdirector_monday==1) { $musicalDays[] = 'Monday'; }
                                                       if(isset($radio->musicdirector_tuesday) && $radio->musicdirector_tuesday==1) { $musicalDays[] = 'Tuesday'; }
                                                       if(isset($radio->musicdirector_wednesday) && $radio->musicdirector_wednesday==1) { $musicalDays[] = 'Wednesday'; }
                                                       if(isset($radio->musicdirector_thursday) && $radio->musicdirector_thursday==1) { $musicalDays[] = 'Thursday'; }
                                                       if(isset($radio->musicdirector_friday) && $radio->musicdirector_friday==1) { $musicalDays[] = 'Friday'; }
                                                       if(isset($radio->musicdirector_satday) && $radio->musicdirector_satday==1) { $musicalDays[] = 'Satday'; }
                                                       if(isset($radio->musicdirector_sunday) && $radio->musicdirector_sunday==1) { $musicalDays[] = 'Sunday'; }
                                                       if(isset($radio->musicdirector_varies) && $radio->musicdirector_varies==1) { $musicalDays[] = 'Varies'; }
         ...
         <?php } if(isset($radio['data'][0]->radiotype_programdirector) && $radio['data'][0]->radiotype_programdirector==1) { ?>			
                             ...
                             <?php if(isset($radio['data'][0]->programirector_showname)){ echo $radio['data'][0]->programirector_showname;}  ?>
                                                 ...
                                                 <div class="profile-info-row">
                                                     ...
                                                     <div class="profile-info-value">
                                                      <?php  $programDays = array();
                                                       if(isset($radio->programdirector_monday) && $radio->programdirector_monday==1) { $programDays[] = 'Monday'; }
                                                       if(isset($radio->programdirector_tuesday) && $radio->programdirector_tuesday==1) { $programDays[] = 'Tuesday'; }
                                                       if(isset($radio->programdirector_wednesday) && $radio->programdirector_wednesday==1) { $programDays[] = 'Wednesday'; }
                                                       if(isset($radio->programdirector_thursday) && $radio->programdirector_thursday==1) { $programDays[] = 'Thursday'; }
                                                       if(isset($radio->programdirector_friday) && $radio->programdirector_friday==1) { $programDays[] = 'Friday'; }
                                                       if(isset($radio->programdirector_satday) && $radio->programdirector_satday==1) { $programDays[] = 'Satday'; }
                                                       if(isset($radio->programdirector_sunday) && $radio->programdirector_sunday==1) { $programDays[] = 'Sunday'; }
                                                       if(isset($radio->programdirector_varies) && $radio->programdirector_varies==1) { $programDays[] = 'Varies'; }
                                                       ...
                                                       {
                                                         if(isset($programDays[0])){
                                                         $program_days = $programDays[0];
                                                         }else{
                                                            $program_days = ''; 
                                                         }
                                                       }
             ...
             <?php } if(isset($radio['data'][0]->radiotype_jock) && $radio['data'][0]->radiotype_jock==1) { ?>			
                                                 ...
                                                 <div class="profile-info-row">
                                                     ...
                                                     <div class="profile-info-value">
                                                      <?php  $personalityDays = array();
                                                       if(isset($radio->onairpersonality_monday) && $radio->onairpersonality_monday==1) { $personalityDays[] = 'Monday'; }
                                                       if(isset($radio->onairpersonality_tuesday) && $radio->onairpersonality_tuesday==1) { $personalityDays[] = 'Tuesday'; }
                                                       if(isset($radio->onairpersonality_wednesday) && $radio->onairpersonality_wednesday==1) { $personalityDays[] = 'Wednesday'; }
                                                       if(isset($radio->onairpersonality_thursday) && $radio->onairpersonality_thursday==1) { $personalityDays[] = 'Thursday'; }
                                                       if(isset($radio->onairpersonality_friday) && $radio->onairpersonality_friday==1) { $personalityDays[] = 'Friday'; }
                                                       if(isset($radio->onairpersonality_satday) && $radio->onairpersonality_satday==1) { $personalityDays[] = 'Satday'; }
                                                       if(isset($radio->onairpersonality_sunday) && $radio->onairpersonality_sunday==1) { $personalityDays[] = 'Sunday'; }
                                                       if(isset($radio->onairpersonality_varies) && $radio->onairpersonality_varies==1) { $personalityDays[] = 'Varies'; }
                                                       ...
                                                       {
                                                          if(isset($personalityDays[0])){
                                                            $personality_days = $personalityDays[0];
                                                          }else{
                                                            $personality_days = '';  
                                                          }
                                                       }
                             ...
                             <?php if(isset($radio['data'][0]->onairpersonality_showtime)){ echo $radio['data'][0]->onairpersonality_showtime; }  ?>
                             
                                                     
                                                     </div>
                                                 </div>
                                         
                                         </div> 	<!--on air director end-->
                                       <?php } ?>               														
                 ...
                 <?php if(isset($media['data'][0]->mediatype_newsletter) && $media['data'][0]->mediatype_newsletter==1) { echo 'Newsletter'; echo '<br />'; } ?>
                              ...
                              <?php if(isset($media['data'][0]->media_department)) { echo $media['data'][0]->media_department;  } ?>
                                                 ...
                                                 <div class="profile-info-row">
                                                     ...
                                                     <div class="profile-info-value">
                                                     <?php  if(isset($media['data'][0]->media_website)) { echo $media['data'][0]->media_website; } ?>
                                                     </div>
                                                 </div>
                             ...
                             <?php if(isset($record['data'][0]->label_name)) { echo $record['data'][0]->label_name; } ?>
                 ...
                 <?php if(isset($record['data'][0]->labeltype_distribution) && $record['data'][0]->labeltype_distribution==1) { echo 'Distribution'; echo '<br />'; } ?>
                                                 ...
                                                 <div class="profile-info-row">
                                                     ...
                                                     <div class="profile-info-value">
                             <?php if(isset($record['data'][0]->label_department)) { echo $record['data'][0]->label_department; } ?>
                                                     </div>
                                                 </div>
                             ...
                             <?php if(isset($management['data'][0]->management_name)) { echo $management['data'][0]->management_name; } ?>
                 ...
                 <?php if(isset($management['data'][0]->managementtype_finance) && $management['data'][0]->managementtype_finance==1) { echo 'Finance/Accounting'; echo '<br />'; } ?>
                             ...
                             <?php  if(isset($clothing['data'][0]->clothing_name)) { echo $clothing['data'][0]->clothing_name; } ?>
                 ...
                 <?php if(isset($clothing['data'][0]->clothing_department)) { echo $clothing['data'][0]->clothing_department; } ?>
                             ...
                             <?php if(isset($promoter['data'][0]->promoter_name)) { echo $promoter['data'][0]->promoter_name; } ?>
  ...
  <?php if(isset($promoter['data'][0]->promoter_department) && strcmp($promoter['data'][0]->promoter_department,'i.t._or_tech')==0) { echo 'I.T./Tech'; } ?> 
                 ...
                 <?php if(isset($promoter['data'][0]->promoter_website)) { echo $promoter['data'][0]->promoter_website; } ?>
             ...
             <?php if(isset($special['data'][0]->servicestype_graphicdesign) && $special['data'][0]->servicestype_graphicdesign==1) { echo 'Graphic Design';  echo '<br />'; } ?> 
                 ...
                 <?php if(isset($special['data'][0]->servicestype_other) && $special['data'][0]->servicestype_other==1) { echo 'Other'; echo '<br />'; } ?> 
                                                 ...
                                                 <div class="profile-info-row">
                                                     ...
                                                     <div class="profile-info-value">
                 <?php if(isset($special['data'][0]->services_name)) { echo $special['data'][0]->services_name; } ?>
                 ...
                 <?php if(isset($special['data'][0]->services_website)) { echo $special['data'][0]->services_website; } ?>
         ...
         <?php if(isset($production['data'][0]->productiontype_choreographer) && $production['data'][0]->productiontype_choreographer==1) { echo 'Choregrapher'; echo '<br />'; } ?> 
                 <?php if(isset($production['data'][0]->productiontype_sound) && $production['data'][0]->productiontype_sound==1) { echo 'Sound Engineer'; echo '<br />'; } ?> 
                                                 ...
                                                 <div class="profile-info-row">
                                                     ...
                                                     <div class="profile-info-value">
                 <?php if(isset($production['data'][0]->production_name)) { echo $production['data'][0]->production_name; } ?>
				...
				<!--testinclude('clients.dashboard.includes.my-tracks')-->
