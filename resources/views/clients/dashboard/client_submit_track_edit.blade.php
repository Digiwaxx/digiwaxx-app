                           ...
                           <div class="" style="">
                                 ...
                                 <div class="col-lg-5 col-md-3 col-sm-4">
                                    <div class="form-group">
                                       <label class="btn" style="padding:0;">
                                          ...
                                          } else if (strlen($track['data'][0]->imgpage) > 4) {
                                          ...
                                          <img src="<?php echo $artWork; ?>" class="img-responsive up-ar-img" id="previewImg"> <input id="artWork" name="artWork" style="display: none;" type="file" accept=".png, .jpg, .jpeg, .gif">
                                       </label>
                                    </div>
                                 </div>
                              </div>
                              <div class="row">
                                 <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                                       <input name="trackTime" id="trackTime" class="form-control input" size="20" placeholder="Track Time" type="text" value="<?php echo urldecode($track['data'][0]->time); ?>">
                                    </div>
                                 </div>
                                 <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-lg-12">
                                    ...
                                    <div class="uptrk" id="uptrk1">
                                       ...
                                       if (strlen($track['data'][0]->link1) > 1) {
                                          $linkDivDisplay1 = 'block';
                                       }

                                       if (strlen($track['data'][0]->link2) > 1) {
                                          $linkDivDisplay2 = 'block';
                                       }
                                 ...
                                 <div class="col-sm-6">
                                    <div class="form-group">
                                       <input name="instagramLink" id="instagramLink" class="form-control input" value="<?php echo $track['data'][0]->instagramLink; ?>" size="20" placeholder="Instagram Link" type="text">
                                    </div>
                                 </div>
                                 <div class="col-sm-6">
                                    <div class="form-group">
                                 ...
                                 <div class="col-sm-6">
                                    <div class="form-group">
                                       <input name="videoURL" id="videolink" class="form-control input" value="<?php echo $track['data'][0]->videoURL; ?>" placeholder="Video Link" type="text">
                                    </div>
                                 </div>
                                 <div class="col-sm-12">
                                    <div class="form-group">
                                       <textarea id="embedvideolink" placeholder="Video Embed Link (Youtube/Vimeo)" name="embedvideoURL" class="form-control input"><?php echo urldecode($track['data'][0]->embedvideoURL); ?></textarea>
                                    </div>
                                 </div>
                                 <div class="col-sm-12">
                                    <div class="form-group">
                                       ...
                                       for ($j = 1; $j <= 6; $j++) {
                                          ...
                                          if (!empty($audio->$key)) { ?>
                                             <tr>
                                                ...
                                                <td class="center">
                                                   <button type="button" class="btn btn-danger delete-track" data-fileid="{{ $audio->$key }}">
                              ...
                              <div id="trackFields">
                                 <?php foreach ($available_keys as $available_key) {
                                    $trackNum = (int) filter_var($available_key, FILTER_SANITIZE_NUMBER_INT);
                                 ?>
                                    <div class="track-group" id="trackGroup<?php echo $trackNum; ?>" style="display: none;">
                                       <div class="form-group"><span class="man"></span>
                                          <input name="title<?php echo $trackNum; ?>" id="title<?php echo $trackNum; ?>"
                                             class="form-control input" size="20" placeholder="Track Title" type="text">
                                       </div>
                                       <div class="form-group"><span class="man"></span>
                                          <label class="btn text-left" style="padding:0;">
                                             <img src="assets/img/uptrack.png" class="img-responsive1">
                                             <input type="hidden" name="amrkeynum[]" value="amr<?php echo $trackNum; ?>">
                                             <input style="height:0px !important;" type="file" id="amr<?php echo $trackNum; ?>"
                                                name="amr<?php echo $trackNum; ?>" accept=".mp3">
                                          </label>
                                       </div>
                                    </div>
                                 <?php } ?>
                              ...
                              <div class="add_remove_track_btn">
                                 <?php if (!empty($available_keys)) { ?>
                                    <a href="javascript:void()" id="addTrackBtn" class="addRemoveLinks mr-3"><i class="fa fa-plus-circle"></i>
                                       <span>Add More Track</span>
                                    </a>
                                 <?php } ?>
                                 <a href="javascript:void()" class="addRemoveLinks" id="removeTrackBtn" style="display: none;"><i class="fa fa-minus-circle"></i>
...
<script>
   $(document).ready(function() {
      $(".delete-track").on("click", function() {
         ...
         $.ajax({
            url: "{{ route('delete.client.submitted.track') }}",
            type: "POST",
            data: {
               _token: "{{ csrf_token() }}",
               file_id: fileId
   ...
   $(document).ready(function() {
      ...
      $("#addTrackBtn").click(function() {
         if (trackIndex < availableTracks.length) {
            let trackNum = availableTracks[trackIndex];
            $("#trackGroup" + trackNum).fadeIn();
            $("#title" + trackNum).attr("required", "required");
            $("#amr" + trackNum).attr("required", "required");
            trackIndex++;
      ...
      $("#removeTrackBtn").click(function() {
         if (trackIndex > 0) {
            trackIndex--;
            let trackNum = availableTracks[trackIndex];
            $("#trackGroup" + trackNum).fadeOut();
            $("#title" + trackNum).val("").removeAttr("required");
            $("#amr" + trackNum).removeAttr("required");
