...
<section class="main-dash">
    ...
    <div class="dash-container-clients">
        <div class="container">
                                    ...
                                    <div class="widget-box">
                                        ...
                                        <div class="col-xs-12 infobox-container users-container">
                                            <div class="infobox infobox-blue">
                                                ...
                                                <div class="infobox-data">
                                                    <span class="infobox-data-number"><?php if (isset($tracksInfo['data'][0]->total_count)) {
                                                                                            echo number_format($tracksInfo['data'][0]->total_count);
                                                                                        } else {
                                                                                            echo "N/A";
                                                                                        } ?></span>
                                            ...
                                            <div class="infobox infobox-green">
                                                ...
                                                <div class="infobox-data">
                                                    <span class="infobox-data-number"><?php if (isset($tracksInfo['data'][0]->approved_count)) {
                                                                                            echo number_format($tracksInfo['data'][0]->approved_count);
                                                                                        } else {
                                                                                            echo "N/A";
                                                                                        } ?></span>
                                            ...
                                            <div class="infobox infobox-red">
                                                ...
                                                <div class="infobox-data">
                                                    <span class="infobox-data-number"><?php if (isset($tracksInfo['data'][0]->unapproved_count)) {
                                                                                            echo number_format($tracksInfo['data'][0]->unapproved_count);
                                                                                        } else {
                                                                                            echo "N/A";
                                                                                        } ?></span>
                                                    <div class="infobox-content">Pending approval</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div><!-- /.widget-box -->
                                        ...
                                        <div class="widget-body">
                                            <div class="widget-main no-padding">
                                                <div class="dialogs" style="max-height: 500px; overflow-y: auto;">
                                                    <?php
                                                    if ($tracksReviews['numRowsWeek']) {
                                                        foreach ($tracksReviews['WeekData'] as $weekly_reviews) {
                                                            // check profile image
                                                    ...
                                                    ?>
                                                            <div class="itemdiv dialogdiv">
                                                                ...
                                                                <div class="body">
                                                                    ...
                                                                    <div class="name"><span>DJ: </span>
                                                                        <a target="_blank" href="{{ url('/Client_track_review_member?memberId=' . $weekly_reviews->member_id) }}"><?php echo $weekly_reviews->fname . ' ' . $weekly_reviews->lname; ?></a> | <span>Track: </span> <a target="_blank" href="{{ url('/Client_track_review?tId=' . $weekly_reviews->track_id) }}"><?php echo urldecode($weekly_reviews->title); ?></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        <?php }
                                                        ...
                                                        <div class="itemdiv dialogdiv">
                                                            ...
                                                            <div class="body">
                                                                <div class="text">No reviews found on your submitted tracks for this week.</div>
                                                            </div>
                                                        </div>
                                                    <?php } ?>
                                ...
                                <div class="col-sm-6 col-xs-12">
                                    <div class="widget-box">
                                        <div class="widget-header">
                                            <h4 class="widget-title lighter smaller">
                                                <i class="ace-icon fa fa-comment blue"></i>
                                                Monthly Track Reviews
                                            </h4>
                                        </div>
                                        <div class="widget-body" id="reviewsSection">
                                            <div class="widget-main no-padding">
                                                <div class="dialogs" style="max-height: 500px; overflow-y: auto;">
                                                    <?php
                                    ...
                                    <div class="widget-box transparent" id="recent-box">
                                        <div class="widget-header">
                                            ...
                                            <div class="widget-toolbar no-border">
                                                <ul class="nav nav-tabs" id="recent-tab" role="tablist">
                                                    <li class="active">
                                                ...
                                                <div class="tab-content padding-8">
                                                    ...
                                                    <div id="member-tab" class="tab-pane">
                                                        ...
                                                        <div class="clearfix">
                                                            <div class="itemdiv memberdiv">
                                                                <div class="user">
                                                                    <img alt="Bob Doe's avatar" src="{{ asset('assets_admin/assets/avatars/avatar1.png')}}" />
                                                                </div>
                                                            ...
                                                            <div class="itemdiv memberdiv">
                                                                <div class="user">
                                                                    <img alt="Joe Doe's avatar" src="{{ asset('assets_admin/assets/avatars/avatar1.png')}}" />
                                                                </div>
                                                            ...
                                                            <div class="itemdiv memberdiv">
                                                                <div class="user">
                                                                    <img alt="Jim Doe's avatar" src="{{ asset('assets_admin/assets/avatars/avatar1.png')}}" />
                                                                </div>
                                                            ...
                                                            <div class="itemdiv memberdiv">
                                                                <div class="user">
                                                                    <img alt="Alex Doe's avatar" src="{{ asset('assets_admin/assets/avatars/avatar5.png')}}" />
                                                                </div>
                                                            ...
                                                            <div class="itemdiv memberdiv">
                                                                <div class="user">
                                                                    <img alt="Susan's avatar" src="{{ asset('assets_admin/assets/avatars/avatar2.png')}}" />
                                                                </div>
                                                            ...
                                                            <div class="itemdiv memberdiv">
                                                                <div class="user">
                                                                    <img alt="Phil Doe's avatar" src="{{ asset('assets_admin/assets/avatars/avatar3.png')}}" />
                                                                </div>
                                                            ...
                                                            <div class="itemdiv memberdiv">
                                                                <div class="user">
                                                                    <img alt="Alexa Doe's avatar" src="{{ asset('assets_admin/assets/avatars/avatar4.png')}}" />
                                                                </div>
                                                    ...
                                                    <div id="comment-tab" class="tab-pane">
                                                        ...
                                                        <div class="comments">
                                                            ...
                                                            <div class="itemdiv commentdiv">
                                                                <div class="user">
                                                                    <img alt="Jennifer's Avatar" src="{{ asset('assets_admin/assets/avatars/avatar2.png')}}" />
                                                                </div>
                                                            ...
                                                            <div class="itemdiv commentdiv">
                                                                <div class="user">
                                                                    <img alt="Joe's Avatar" src="{{ asset('assets_admin/assets/avatars/avatar3.png')}}" />
                                                                </div>
                                                            ...
                                                            <div class="itemdiv commentdiv">
                                                                <div class="user">
                                                                    <img alt="Rita's Avatar" src="{{ asset('assets_admin/assets/avatars/avatar4.png')}}" />
                                                                </div>
