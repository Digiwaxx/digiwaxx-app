...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="rgt1">
                <p class="text-center" style="padding:70px 20px;">Please check your spam folder for digiwaxx notifications and whitelist our email address to activate your account.<br>
