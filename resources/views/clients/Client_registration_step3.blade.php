    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="" method="post" id="registrationForm">   
              ...
              <!--<div class="rgt1">-->
              <!--      <p class="text-center">-->
              <!--          A valid email address MUST be supplied to receive  approval. <br>-->
              ...
              <!--  </div>-->
                <div class="package_info">
                    ...
                    <!--    <a href="{{route('client_package_selection_registration')}}"><button type="button" class="btn btn-link">SELECT ANOTHER PACKAGE</button></a>-->
                    <!--</p>-->
                </div>
           ...
           <form action="package_payment_client/checkout" method="post">
               @csrf
               ...
               <script src="https://checkout.stripe.com/checkout.js" class="stripe-button"
                      ...
                      data-amount="<?php echo $package_price*100; ?>"
                       data-locale="auto">
               </script>
           </form>
           <?php }?>
